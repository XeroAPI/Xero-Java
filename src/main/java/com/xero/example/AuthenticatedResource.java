...
public class AuthenticatedResource extends HttpServlet 
{
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
        ...
        accountingApi.setXeroTenantId(xeroTenantId);       
...
*/
			...
			try {	
				...
				CreditNotes newCreditNote = accountingApi.createCreditNote(newCNs, summarizeErrors);
...
// Error: 400
			...
			try {	
				...
				// Get One
				Employees oneEmployee = accountingApi.getEmployee(newEmpId);
...
// 404 ERROR
				...
				Employees updateEmployee = accountingApi.updateEmployee(newEmpId, newEmployee);
			...
			Attachments createdAttachments = accountingApi.createInvoiceAttachmentByFileName(invoiceID, newFileName, requestBodyFile);
