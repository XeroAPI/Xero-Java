...
public class PayrollUkApi {
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public BenefitObject  createBenefit(String accessToken, String xeroTenantId, Benefit benefit, String idempotencyKey) throws IOException {
        try {
            ...
            HttpResponse response = createBenefitForHttpResponse(accessToken, xeroTenantId, benefit, idempotencyKey);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public EmployeeOpeningBalancesObject  createEmployeeOpeningBalances(String accessToken, String xeroTenantId, UUID employeeID, EmployeeOpeningBalances employeeOpeningBalances, String idempotencyKey) throws IOException {
        try {
            ...
            HttpResponse response = createEmployeeOpeningBalancesForHttpResponse(accessToken, xeroTenantId, employeeID, employeeOpeningBalances, idempotencyKey);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public EmployeeStatutorySickLeaveObject  createEmployeeStatutorySickLeave(String accessToken, String xeroTenantId, EmployeeStatutorySickLeave employeeStatutorySickLeave, String idempotencyKey) throws IOException {
        try {
            ...
            HttpResponse response = createEmployeeStatutorySickLeaveForHttpResponse(accessToken, xeroTenantId, employeeStatutorySickLeave, idempotencyKey);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
            ...
            XeroApiExceptionHandler handler = new XeroApiExceptionHandler();
             if (e.getStatusCode() == 400 || e.getStatusCode() == 405) {
                ...
                handler.validationError(e.getStatusCode(),"EmployeeStatutorySickLeaveObject",object.getProblem(), e);
            } else {
                handler.execute(e);
            }
        } catch (IOException ioe) {
        ...
        try {
            ...
            XeroApiExceptionHandler handler = new XeroApiExceptionHandler();
             if (e.getStatusCode() == 400 || e.getStatusCode() == 405) {
                ...
                handler.validationError(e.getStatusCode(),"EmployeePayTemplateObject",object.getProblem(), e);
            } else {
                handler.execute(e);
            }
        } catch (IOException ioe) {
        ...
        try {
            ...
            XeroApiExceptionHandler handler = new XeroApiExceptionHandler();
             if (e.getStatusCode() == 400 || e.getStatusCode() == 405) {
                ...
                handler.validationError(e.getStatusCode(),"EmployeeStatutoryLeaveBalanceObject",object.getProblem(), e);
            } else {
                handler.execute(e);
            }
        } catch (IOException ioe) {
        ...
        try {
            ...
            XeroApiExceptionHandler handler = new XeroApiExceptionHandler();
             if (e.getStatusCode() == 400 || e.getStatusCode() == 405) {
                ...
                handler.validationError(e.getStatusCode(),"EmployeeStatutoryLeavesSummaries",object.getProblem(), e);
            } else {
                handler.execute(e);
            }
        } catch (IOException ioe) {
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public EmployeeOpeningBalancesObject  updateEmployeeOpeningBalances(String accessToken, String xeroTenantId, UUID employeeID, EmployeeOpeningBalances employeeOpeningBalances, String idempotencyKey) throws IOException {
        try {
            TypeReference<EmployeeOpeningBalancesObject> typeRef = new TypeReference<EmployeeOpeningBalancesObject>() {};
            HttpResponse response = updateEmployeeOpeningBalancesForHttpResponse(accessToken, xeroTenantId, employeeID, employeeOpeningBalances, idempotencyKey);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
