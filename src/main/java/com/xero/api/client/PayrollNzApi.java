...
public class PayrollNzApi {
    ...
    final static Logger logger = LoggerFactory.getLogger(PayrollNzApi.class);
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public TimesheetObject  approveTimesheet(String accessToken, String xeroTenantId, UUID timesheetID, String idempotencyKey) throws IOException {
        try {
            ...
            HttpResponse response = approveTimesheetForHttpResponse(accessToken, xeroTenantId, timesheetID, idempotencyKey);
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public DeductionObject  createDeduction(String accessToken, String xeroTenantId, Deduction deduction, String idempotencyKey) throws IOException {
        try {
            ...
            HttpResponse response = createDeductionForHttpResponse(accessToken, xeroTenantId, deduction, idempotencyKey);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public EarningsRateObject  createEarningsRate(String accessToken, String xeroTenantId, EarningsRate earningsRate, String idempotencyKey) throws IOException {
        try {
            ...
            HttpResponse response = createEarningsRateForHttpResponse(accessToken, xeroTenantId, earningsRate, idempotencyKey);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public EmployeeObject  createEmployee(String accessToken, String xeroTenantId, Employee employee, String idempotencyKey) throws IOException {
        try {
            ...
            HttpResponse response = createEmployeeForHttpResponse(accessToken, xeroTenantId, employee, idempotencyKey);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public EarningsTemplateObject  createEmployeeEarningsTemplate(String accessToken, String xeroTenantId, UUID employeeID, EarningsTemplate earningsTemplate, String idempotencyKey) throws IOException {
        try {
            ...
            HttpResponse response = createEmployeeEarningsTemplateForHttpResponse(accessToken, xeroTenantId, employeeID, earningsTemplate, idempotencyKey);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public EmployeeLeaveObject  createEmployeeLeave(String accessToken, String xeroTenantId, UUID employeeID, EmployeeLeave employeeLeave, String idempotencyKey) throws IOException {
        try {
            ...
            HttpResponse response = createEmployeeLeaveForHttpResponse(accessToken, xeroTenantId, employeeID, employeeLeave, idempotencyKey);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public EmployeeLeaveSetupObject  createEmployeeLeaveSetup(String accessToken, String xeroTenantId, UUID employeeID, EmployeeLeaveSetup employeeLeaveSetup, String idempotencyKey) throws IOException {
        try {
            TypeReference<EmployeeLeaveSetupObject> typeRef = new TypeReference<EmployeeLeaveSetupObject>() {};
            HttpResponse response = createEmployeeLeaveSetupForHttpResponse(accessToken, xeroTenantId, employeeID, employeeLeaveSetup, idempotencyKey);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
                logger.debug("------------------ HttpResponseException " + e.getStatusCode() + " : createEmployeeLeaveSetup -------------------");
                logger.debug(e.toString());
            }
            XeroApiExceptionHandler handler = new XeroApiExceptionHandler();
             if (e.getStatusCode() == 400 || e.getStatusCode() == 405) {
                TypeReference<EmployeeLeaveSetupObject> errorTypeRef = new TypeReference<EmployeeLeaveSetupObject>() {};
                EmployeeLeaveSetupObject object = apiClient.getObjectMapper().readValue(e.getContent(), errorTypeRef);
                handler.validationError(e.getStatusCode(),"EmployeeLeaveSetupObject",object.getProblem(), e);
            } else {
                handler.execute(e);
            }
        } catch (IOException ioe) {
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public HttpResponse createEmployeeLeaveSetupForHttpResponse(String accessToken, String xeroTenantId, UUID employeeID, EmployeeLeaveSetup employeeLeaveSetup, String idempotencyKey) throws IOException {
        // verify the required parameter 'xeroTenantId' is set
        if (xeroTenantId == null) {
            throw new IllegalArgumentException("Missing the required parameter 'xeroTenantId' when calling createEmployeeLeaveSetup");
        }// verify the required parameter 'employeeID' is set
        if (employeeID == null) {
            throw new IllegalArgumentException("Missing the required parameter 'employeeID' when calling createEmployeeLeaveSetup");
        }// verify the required parameter 'employeeLeaveSetup' is set
        if (employeeLeaveSetup == null) {
            throw new IllegalArgumentException("Missing the required parameter 'employeeLeaveSetup' when calling createEmployeeLeaveSetup");
        }
        if (accessToken == null) {
            throw new IllegalArgumentException("Missing the required parameter 'accessToken' when calling createEmployeeLeaveSetup");
        }
        HttpHeaders headers = new HttpHeaders();
        headers.set("Xero-Tenant-Id", xeroTenantId);
        headers.set("Idempotency-Key", idempotencyKey);
        ...
        UriBuilder uriBuilder = UriBuilder.fromUri(apiClient.getBasePath() + "/Employees/{EmployeeID}/LeaveSetup");
        String url = uriBuilder.buildFromMap(uriVariables).toString();
        GenericUrl genericUrl = new GenericUrl(url);
        if (logger.isDebugEnabled()) {
            logger.debug("POST " + genericUrl.toString());
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public EmployeeLeaveTypeObject  createEmployeeLeaveType(String accessToken, String xeroTenantId, UUID employeeID, EmployeeLeaveType employeeLeaveType, String idempotencyKey) throws IOException {
        try {
            ...
            HttpResponse response = createEmployeeLeaveTypeForHttpResponse(accessToken, xeroTenantId, employeeID, employeeLeaveType, idempotencyKey);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
            ...
            XeroApiExceptionHandler handler = new XeroApiExceptionHandler();
             if (e.getStatusCode() == 400 || e.getStatusCode() == 405) {
                ...
                handler.validationError(e.getStatusCode(),"EmployeeLeaveTypeObject",object.getProblem(), e);
            } else {
                handler.execute(e);
            }
        } catch (IOException ioe) {
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public EmployeeOpeningBalancesObject  createEmployeeOpeningBalances(String accessToken, String xeroTenantId, UUID employeeID, List<EmployeeOpeningBalance> employeeOpeningBalance, String idempotencyKey) throws IOException {
        try {
            TypeReference<EmployeeOpeningBalancesObject> typeRef = new TypeReference<EmployeeOpeningBalancesObject>() {};
            HttpResponse response = createEmployeeOpeningBalancesForHttpResponse(accessToken, xeroTenantId, employeeID, employeeOpeningBalance, idempotencyKey);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
            ...
            XeroApiExceptionHandler handler = new XeroApiExceptionHandler();
             if (e.getStatusCode() == 400 || e.getStatusCode() == 405) {
                ...
                handler.validationError(e.getStatusCode(),"EmployeeOpeningBalancesObject",object.getProblem(), e);
            } else {
                handler.execute(e);
            }
        } catch (IOException ioe) {
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public HttpResponse createEmployeeOpeningBalancesForHttpResponse(String accessToken, String xeroTenantId, UUID employeeID, List<EmployeeOpeningBalance> employeeOpeningBalance, String idempotencyKey) throws IOException {
        // verify the required parameter 'xeroTenantId' is set
        if (xeroTenantId == null) {
        ...
        if (employeeOpeningBalance == null) {
            throw new IllegalArgumentException("Missing the required parameter 'employeeOpeningBalance' when calling createEmployeeOpeningBalances");
        }
        if (accessToken == null) {
        ...
        UriBuilder uriBuilder = UriBuilder.fromUri(apiClient.getBasePath() + "/Employees/{EmployeeID}/OpeningBalances");
        String url = uriBuilder.buildFromMap(uriVariables).toString();
        GenericUrl genericUrl = new GenericUrl(url);
        if (logger.isDebugEnabled()) {
            logger.debug("POST " + genericUrl.toString());
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public PaymentMethodObject  createEmployeePaymentMethod(String accessToken, String xeroTenantId, UUID employeeID, PaymentMethod paymentMethod, String idempotencyKey) throws IOException {
        try {
            ...
            HttpResponse response = createEmployeePaymentMethodForHttpResponse(accessToken, xeroTenantId, employeeID, paymentMethod, idempotencyKey);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public SalaryAndWageObject  createEmployeeSalaryAndWage(String accessToken, String xeroTenantId, UUID employeeID, SalaryAndWage salaryAndWage, String idempotencyKey) throws IOException {
        try {
            ...
            HttpResponse response = createEmployeeSalaryAndWageForHttpResponse(accessToken, xeroTenantId, employeeID, salaryAndWage, idempotencyKey);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
    ...
    * <p><b>200</b> - employee working pattern correctly added
    * <p><b>400</b> - validation error for a bad request
    * @param xeroTenantId Xero identifier for Tenant
    * @param employeeID Employee id for single object
    * @param employeeWorkingPatternWithWorkingWeeksRequest The employeeWorkingPatternWithWorkingWeeksRequest parameter
    * @param idempotencyKey This allows you to safely retry requests without the risk of duplicate processing. 128 character max.
    * @param accessToken Authorization token for user set in header of each request
    * @return  EmployeeWorkingPatternWithWorkingWeeksObject
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public EmployeeWorkingPatternWithWorkingWeeksObject  createEmployeeWorkingPattern(String accessToken, String xeroTenantId, UUID employeeID, EmployeeWorkingPatternWithWorkingWeeksRequest employeeWorkingPatternWithWorkingWeeksRequest, String idempotencyKey) throws IOException {
        try {
            TypeReference<EmployeeWorkingPatternWithWorkingWeeksObject> typeRef = new TypeReference<EmployeeWorkingPatternWithWorkingWeeksObject>() {};
            HttpResponse response = createEmployeeWorkingPatternForHttpResponse(accessToken, xeroTenantId, employeeID, employeeWorkingPatternWithWorkingWeeksRequest, idempotencyKey);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
                logger.debug("------------------ HttpResponseException " + e.getStatusCode() + " : createEmployeeWorkingPattern -------------------");
                logger.debug(e.toString());
            }
            XeroApiExceptionHandler handler = new XeroApiExceptionHandler();
             if (e.getStatusCode() == 400 || e.getStatusCode() == 405) {
                TypeReference<EmployeeWorkingPatternWithWorkingWeeksObject> errorTypeRef = new TypeReference<EmployeeWorkingPatternWithWorkingWeeksObject>() {};
                EmployeeWorkingPatternWithWorkingWeeksObject object = apiClient.getObjectMapper().readValue(e.getContent(), errorTypeRef);
                handler.validationError(e.getStatusCode(),"EmployeeWorkingPatternWithWorkingWeeksObject",object.getProblem(), e);
            } else {
                handler.execute(e);
            }
        } catch (IOException ioe) {
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public HttpResponse createEmployeeWorkingPatternForHttpResponse(String accessToken, String xeroTenantId, UUID employeeID, EmployeeWorkingPatternWithWorkingWeeksRequest employeeWorkingPatternWithWorkingWeeksRequest, String idempotencyKey) throws IOException {
        // verify the required parameter 'xeroTenantId' is set
        if (xeroTenantId == null) {
            throw new IllegalArgumentException("Missing the required parameter 'xeroTenantId' when calling createEmployeeWorkingPattern");
        }// verify the required parameter 'employeeID' is set
        if (employeeID == null) {
            throw new IllegalArgumentException("Missing the required parameter 'employeeID' when calling createEmployeeWorkingPattern");
        ...
        if (employeeWorkingPatternWithWorkingWeeksRequest == null) {
            throw new IllegalArgumentException("Missing the required parameter 'employeeWorkingPatternWithWorkingWeeksRequest' when calling createEmployeeWorkingPattern");
        }
        if (accessToken == null) {
            throw new IllegalArgumentException("Missing the required parameter 'accessToken' when calling createEmployeeWorkingPattern");
        }
        HttpHeaders headers = new HttpHeaders();
        headers.set("Xero-Tenant-Id", xeroTenantId);
        headers.set("Idempotency-Key", idempotencyKey);
        ...
        UriBuilder uriBuilder = UriBuilder.fromUri(apiClient.getBasePath() + "/Employees/{EmployeeID}/Working-Patterns");
        String url = uriBuilder.buildFromMap(uriVariables).toString();
        GenericUrl genericUrl = new GenericUrl(url);
        if (logger.isDebugEnabled()) {
            logger.debug("POST " + genericUrl.toString());
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public EmploymentObject  createEmployment(String accessToken, String xeroTenantId, UUID employeeID, Employment employment, String idempotencyKey) throws IOException {
        try {
            ...
            HttpResponse response = createEmploymentForHttpResponse(accessToken, xeroTenantId, employeeID, employment, idempotencyKey);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public LeaveTypeObject  createLeaveType(String accessToken, String xeroTenantId, LeaveType leaveType, String idempotencyKey) throws IOException {
        try {
            ...
            HttpResponse response = createLeaveTypeForHttpResponse(accessToken, xeroTenantId, leaveType, idempotencyKey);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public EmployeeEarningsTemplates  createMultipleEmployeeEarningsTemplate(String accessToken, String xeroTenantId, UUID employeeID, List<EarningsTemplate> earningsTemplate, String idempotencyKey) throws IOException {
        try {
            TypeReference<EmployeeEarningsTemplates> typeRef = new TypeReference<EmployeeEarningsTemplates>() {};
            HttpResponse response = createMultipleEmployeeEarningsTemplateForHttpResponse(accessToken, xeroTenantId, employeeID, earningsTemplate, idempotencyKey);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
            ...
            XeroApiExceptionHandler handler = new XeroApiExceptionHandler();
             if (e.getStatusCode() == 400 || e.getStatusCode() == 405) {
                TypeReference<EmployeeEarningsTemplates> errorTypeRef = new TypeReference<EmployeeEarningsTemplates>() {};
                EmployeeEarningsTemplates object = apiClient.getObjectMapper().readValue(e.getContent(), errorTypeRef);
                handler.validationError(e.getStatusCode(),"EmployeeEarningsTemplates",object.getProblem(), e);
            } else {
                handler.execute(e);
            }
        } catch (IOException ioe) {
    ...
    * @return  PayRunObject
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public PayRunObject  createPayRun(String accessToken, String xeroTenantId, PayRun payRun, String idempotencyKey) throws IOException {
        try {
            TypeReference<PayRunObject> typeRef = new TypeReference<PayRunObject>() {};
            HttpResponse response = createPayRunForHttpResponse(accessToken, xeroTenantId, payRun, idempotencyKey);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public HttpResponse createPayRunForHttpResponse(String accessToken, String xeroTenantId, PayRun payRun, String idempotencyKey) throws IOException {
        // verify the required parameter 'xeroTenantId' is set
        if (xeroTenantId == null) {
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public PayRunCalendarObject  createPayRunCalendar(String accessToken, String xeroTenantId, PayRunCalendar payRunCalendar, String idempotencyKey) throws IOException {
        try {
            ...
            HttpResponse response = createPayRunCalendarForHttpResponse(accessToken, xeroTenantId, payRunCalendar, idempotencyKey);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public ReimbursementObject  createReimbursement(String accessToken, String xeroTenantId, Reimbursement reimbursement, String idempotencyKey) throws IOException {
        try {
            ...
            HttpResponse response = createReimbursementForHttpResponse(accessToken, xeroTenantId, reimbursement, idempotencyKey);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public SuperannuationObject  createSuperannuation(String accessToken, String xeroTenantId, Benefit benefit, String idempotencyKey) throws IOException {
        try {
            TypeReference<SuperannuationObject> typeRef = new TypeReference<SuperannuationObject>() {};
            HttpResponse response = createSuperannuationForHttpResponse(accessToken, xeroTenantId, benefit, idempotencyKey);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
                logger.debug("------------------ HttpResponseException " + e.getStatusCode() + " : createSuperannuation -------------------");
                logger.debug(e.toString());
            }
            XeroApiExceptionHandler handler = new XeroApiExceptionHandler();
             if (e.getStatusCode() == 400 || e.getStatusCode() == 405) {
                TypeReference<SuperannuationObject> errorTypeRef = new TypeReference<SuperannuationObject>() {};
                SuperannuationObject object = apiClient.getObjectMapper().readValue(e.getContent(), errorTypeRef);
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public HttpResponse createSuperannuationForHttpResponse(String accessToken, String xeroTenantId, Benefit benefit, String idempotencyKey) throws IOException {
        // verify the required parameter 'xeroTenantId' is set
        if (xeroTenantId == null) {
            throw new IllegalArgumentException("Missing the required parameter 'xeroTenantId' when calling createSuperannuation");
        }// verify the required parameter 'benefit' is set
        if (benefit == null) {
            throw new IllegalArgumentException("Missing the required parameter 'benefit' when calling createSuperannuation");
        }
        if (accessToken == null) {
            throw new IllegalArgumentException("Missing the required parameter 'accessToken' when calling createSuperannuation");
        }
        HttpHeaders headers = new HttpHeaders();
        headers.set("Xero-Tenant-Id", xeroTenantId);
        headers.set("Idempotency-Key", idempotencyKey);
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public TimesheetObject  createTimesheet(String accessToken, String xeroTenantId, Timesheet timesheet, String idempotencyKey) throws IOException {
        try {
            TypeReference<TimesheetObject> typeRef = new TypeReference<TimesheetObject>() {};
            HttpResponse response = createTimesheetForHttpResponse(accessToken, xeroTenantId, timesheet, idempotencyKey);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public TimesheetLineObject  createTimesheetLine(String accessToken, String xeroTenantId, UUID timesheetID, TimesheetLine timesheetLine, String idempotencyKey) throws IOException {
        try {
            ...
            HttpResponse response = createTimesheetLineForHttpResponse(accessToken, xeroTenantId, timesheetID, timesheetLine, idempotencyKey);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public EarningsTemplateObject  deleteEmployeeEarningsTemplate(String accessToken, String xeroTenantId, UUID employeeID, UUID payTemplateEarningID) throws IOException {
        try {
            TypeReference<EarningsTemplateObject> typeRef = new TypeReference<EarningsTemplateObject>() {};
            HttpResponse response = deleteEmployeeEarningsTemplateForHttpResponse(accessToken, xeroTenantId, employeeID, payTemplateEarningID);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public SalaryAndWageObject  deleteEmployeeSalaryAndWage(String accessToken, String xeroTenantId, UUID employeeID, UUID salaryAndWagesID) throws IOException {
        try {
            TypeReference<SalaryAndWageObject> typeRef = new TypeReference<SalaryAndWageObject>() {};
            HttpResponse response = deleteEmployeeSalaryAndWageForHttpResponse(accessToken, xeroTenantId, employeeID, salaryAndWagesID);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
    ...
    * @return  EmployeeLeaveObject
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public EmployeeLeaveObject  deleteEmployeeWorkingPattern(String accessToken, String xeroTenantId, UUID employeeID, UUID employeeWorkingPatternID) throws IOException {
        try {
            TypeReference<EmployeeLeaveObject> typeRef = new TypeReference<EmployeeLeaveObject>() {};
            HttpResponse response = deleteEmployeeWorkingPatternForHttpResponse(accessToken, xeroTenantId, employeeID, employeeWorkingPatternID);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
                logger.debug("------------------ HttpResponseException " + e.getStatusCode() + " : deleteEmployeeWorkingPattern -------------------");
                logger.debug(e.toString());
            }
            XeroApiExceptionHandler handler = new XeroApiExceptionHandler();
             if (e.getStatusCode() == 400 || e.getStatusCode() == 405) {
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public HttpResponse deleteEmployeeWorkingPatternForHttpResponse(String accessToken, String xeroTenantId, UUID employeeID, UUID employeeWorkingPatternID) throws IOException {
        // verify the required parameter 'xeroTenantId' is set
        if (xeroTenantId == null) {
            throw new IllegalArgumentException("Missing the required parameter 'xeroTenantId' when calling deleteEmployeeWorkingPattern");
        }// verify the required parameter 'employeeID' is set
        if (employeeID == null) {
            throw new IllegalArgumentException("Missing the required parameter 'employeeID' when calling deleteEmployeeWorkingPattern");
        }// verify the required parameter 'employeeWorkingPatternID' is set
        if (employeeWorkingPatternID == null) {
            throw new IllegalArgumentException("Missing the required parameter 'employeeWorkingPatternID' when calling deleteEmployeeWorkingPattern");
        }
        if (accessToken == null) {
            throw new IllegalArgumentException("Missing the required parameter 'accessToken' when calling deleteEmployeeWorkingPattern");
        }
        HttpHeaders headers = new HttpHeaders();
        headers.set("Xero-Tenant-Id", xeroTenantId);
        headers.setAccept("application/json"); 
        ...
        UriBuilder uriBuilder = UriBuilder.fromUri(apiClient.getBasePath() + "/Employees/{EmployeeID}/Working-Patterns/{EmployeeWorkingPatternID}");
        String url = uriBuilder.buildFromMap(uriVariables).toString();
        GenericUrl genericUrl = new GenericUrl(url);
        if (logger.isDebugEnabled()) {
            logger.debug("DELETE " + genericUrl.toString());
    ...
    * @return  EmployeeWorkingPatternWithWorkingWeeksObject
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public EmployeeWorkingPatternWithWorkingWeeksObject  getEmployeeWorkingPattern(String accessToken, String xeroTenantId, UUID employeeID, UUID employeeWorkingPatternID) throws IOException {
        try {
            TypeReference<EmployeeWorkingPatternWithWorkingWeeksObject> typeRef = new TypeReference<EmployeeWorkingPatternWithWorkingWeeksObject>() {};
            HttpResponse response = getEmployeeWorkingPatternForHttpResponse(accessToken, xeroTenantId, employeeID, employeeWorkingPatternID);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
                logger.debug("------------------ HttpResponseException " + e.getStatusCode() + " : getEmployeeWorkingPattern -------------------");
                logger.debug(e.toString());
            }
            XeroApiExceptionHandler handler = new XeroApiExceptionHandler();
             if (e.getStatusCode() == 400 || e.getStatusCode() == 405) {
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public HttpResponse getEmployeeWorkingPatternForHttpResponse(String accessToken, String xeroTenantId, UUID employeeID, UUID employeeWorkingPatternID) throws IOException {
        // verify the required parameter 'xeroTenantId' is set
        if (xeroTenantId == null) {
            throw new IllegalArgumentException("Missing the required parameter 'xeroTenantId' when calling getEmployeeWorkingPattern");
        }// verify the required parameter 'employeeID' is set
        if (employeeID == null) {
            throw new IllegalArgumentException("Missing the required parameter 'employeeID' when calling getEmployeeWorkingPattern");
        }// verify the required parameter 'employeeWorkingPatternID' is set
        if (employeeWorkingPatternID == null) {
            throw new IllegalArgumentException("Missing the required parameter 'employeeWorkingPatternID' when calling getEmployeeWorkingPattern");
        }
        if (accessToken == null) {
            throw new IllegalArgumentException("Missing the required parameter 'accessToken' when calling getEmployeeWorkingPattern");
        }
        HttpHeaders headers = new HttpHeaders();
        headers.set("Xero-Tenant-Id", xeroTenantId);
        headers.setAccept("application/json"); 
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public EmployeeWorkingPatternsObject  getEmployeeWorkingPatterns(String accessToken, String xeroTenantId, UUID employeeID) throws IOException {
        try {
            TypeReference<EmployeeWorkingPatternsObject> typeRef = new TypeReference<EmployeeWorkingPatternsObject>() {};
            HttpResponse response = getEmployeeWorkingPatternsForHttpResponse(accessToken, xeroTenantId, employeeID);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
                logger.debug("------------------ HttpResponseException " + e.getStatusCode() + " : getEmployeeWorkingPatterns -------------------");
                logger.debug(e.toString());
            }
            XeroApiExceptionHandler handler = new XeroApiExceptionHandler();
             if (e.getStatusCode() == 400 || e.getStatusCode() == 405) {
                TypeReference<EmployeeWorkingPatternsObject> errorTypeRef = new TypeReference<EmployeeWorkingPatternsObject>() {};
                EmployeeWorkingPatternsObject object = apiClient.getObjectMapper().readValue(e.getContent(), errorTypeRef);
                handler.validationError(e.getStatusCode(),"EmployeeWorkingPatternsObject",object.getProblem(), e);
            } else {
                handler.execute(e);
            }
        } catch (IOException ioe) {
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public HttpResponse getEmployeeWorkingPatternsForHttpResponse(String accessToken, String xeroTenantId, UUID employeeID) throws IOException {
        // verify the required parameter 'xeroTenantId' is set
        if (xeroTenantId == null) {
            throw new IllegalArgumentException("Missing the required parameter 'xeroTenantId' when calling getEmployeeWorkingPatterns");
        }// verify the required parameter 'employeeID' is set
        if (employeeID == null) {
            throw new IllegalArgumentException("Missing the required parameter 'employeeID' when calling getEmployeeWorkingPatterns");
        }
        if (accessToken == null) {
            throw new IllegalArgumentException("Missing the required parameter 'accessToken' when calling getEmployeeWorkingPatterns");
        }
        HttpHeaders headers = new HttpHeaders();
        headers.set("Xero-Tenant-Id", xeroTenantId);
        headers.setAccept("application/json"); 
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public PayRunCalendarObject  getPayRunCalendar(String accessToken, String xeroTenantId, UUID payrollCalendarID) throws IOException {
        try {
            TypeReference<PayRunCalendarObject> typeRef = new TypeReference<PayRunCalendarObject>() {};
            HttpResponse response = getPayRunCalendarForHttpResponse(accessToken, xeroTenantId, payrollCalendarID);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public HttpResponse getPayRunCalendarForHttpResponse(String accessToken, String xeroTenantId, UUID payrollCalendarID) throws IOException {
        // verify the required parameter 'xeroTenantId' is set
        if (xeroTenantId == null) {
        ...
        if (payrollCalendarID == null) {
            throw new IllegalArgumentException("Missing the required parameter 'payrollCalendarID' when calling getPayRunCalendar");
        }
        if (accessToken == null) {
        ...
        UriBuilder uriBuilder = UriBuilder.fromUri(apiClient.getBasePath() + "/PayRunCalendars/{PayrollCalendarID}");
        String url = uriBuilder.buildFromMap(uriVariables).toString();
        GenericUrl genericUrl = new GenericUrl(url);
        if (logger.isDebugEnabled()) {
            logger.debug("GET " + genericUrl.toString());
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public StatutoryDeductionObject  getStatutoryDeduction(String accessToken, String xeroTenantId, UUID id) throws IOException {
        try {
            TypeReference<StatutoryDeductionObject> typeRef = new TypeReference<StatutoryDeductionObject>() {};
            HttpResponse response = getStatutoryDeductionForHttpResponse(accessToken, xeroTenantId, id);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
                logger.debug("------------------ HttpResponseException " + e.getStatusCode() + " : getStatutoryDeduction -------------------");
                logger.debug(e.toString());
            }
            XeroApiExceptionHandler handler = new XeroApiExceptionHandler();
            handler.execute(e);
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public HttpResponse getStatutoryDeductionForHttpResponse(String accessToken, String xeroTenantId, UUID id) throws IOException {
        // verify the required parameter 'xeroTenantId' is set
        if (xeroTenantId == null) {
            throw new IllegalArgumentException("Missing the required parameter 'xeroTenantId' when calling getStatutoryDeduction");
        }// verify the required parameter 'id' is set
        if (id == null) {
            throw new IllegalArgumentException("Missing the required parameter 'id' when calling getStatutoryDeduction");
        }
        if (accessToken == null) {
            throw new IllegalArgumentException("Missing the required parameter 'accessToken' when calling getStatutoryDeduction");
        }
        HttpHeaders headers = new HttpHeaders();
        headers.set("Xero-Tenant-Id", xeroTenantId);
        headers.setAccept("application/json"); 
        ...
        UriBuilder uriBuilder = UriBuilder.fromUri(apiClient.getBasePath() + "/StatutoryDeductions/{id}");
        String url = uriBuilder.buildFromMap(uriVariables).toString();
        GenericUrl genericUrl = new GenericUrl(url);
        if (logger.isDebugEnabled()) {
            logger.debug("GET " + genericUrl.toString());
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public StatutoryDeductions  getStatutoryDeductions(String accessToken, String xeroTenantId, Integer page) throws IOException {
        try {
            ...
            HttpResponse response = getStatutoryDeductionsForHttpResponse(accessToken, xeroTenantId, page);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
                logger.debug("------------------ HttpResponseException " + e.getStatusCode() + " : getStatutoryDeductions -------------------");
                logger.debug(e.toString());
            }
            XeroApiExceptionHandler handler = new XeroApiExceptionHandler();
            handler.execute(e);
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public HttpResponse getStatutoryDeductionsForHttpResponse(String accessToken, String xeroTenantId, Integer page) throws IOException {
        // verify the required parameter 'xeroTenantId' is set
        if (xeroTenantId == null) {
            throw new IllegalArgumentException("Missing the required parameter 'xeroTenantId' when calling getStatutoryDeductions");
        }
        if (accessToken == null) {
            throw new IllegalArgumentException("Missing the required parameter 'accessToken' when calling getStatutoryDeductions");
        }
        HttpHeaders headers = new HttpHeaders();
        headers.set("Xero-Tenant-Id", xeroTenantId);
        headers.setAccept("application/json"); 
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public SuperannuationObject  getSuperannuation(String accessToken, String xeroTenantId, UUID superannuationID) throws IOException {
        try {
            TypeReference<SuperannuationObject> typeRef = new TypeReference<SuperannuationObject>() {};
            HttpResponse response = getSuperannuationForHttpResponse(accessToken, xeroTenantId, superannuationID);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
                logger.debug("------------------ HttpResponseException " + e.getStatusCode() + " : getSuperannuation -------------------");
                logger.debug(e.toString());
            }
            XeroApiExceptionHandler handler = new XeroApiExceptionHandler();
            handler.execute(e);
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public HttpResponse getSuperannuationForHttpResponse(String accessToken, String xeroTenantId, UUID superannuationID) throws IOException {
        // verify the required parameter 'xeroTenantId' is set
        if (xeroTenantId == null) {
            throw new IllegalArgumentException("Missing the required parameter 'xeroTenantId' when calling getSuperannuation");
        }// verify the required parameter 'superannuationID' is set
        if (superannuationID == null) {
            throw new IllegalArgumentException("Missing the required parameter 'superannuationID' when calling getSuperannuation");
        }
        if (accessToken == null) {
            throw new IllegalArgumentException("Missing the required parameter 'accessToken' when calling getSuperannuation");
        }
        HttpHeaders headers = new HttpHeaders();
        headers.set("Xero-Tenant-Id", xeroTenantId);
        headers.setAccept("application/json"); 
        ...
        UriBuilder uriBuilder = UriBuilder.fromUri(apiClient.getBasePath() + "/Superannuations/{SuperannuationID}");
        String url = uriBuilder.buildFromMap(uriVariables).toString();
        GenericUrl genericUrl = new GenericUrl(url);
        if (logger.isDebugEnabled()) {
            logger.debug("GET " + genericUrl.toString());
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public Superannuations  getSuperannuations(String accessToken, String xeroTenantId, Integer page) throws IOException {
        try {
            ...
            if (logger.isDebugEnabled()) {
                logger.debug("------------------ HttpResponseException " + e.getStatusCode() + " : getSuperannuations -------------------");
                logger.debug(e.toString());
            }
            XeroApiExceptionHandler handler = new XeroApiExceptionHandler();
            handler.execute(e);
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public HttpResponse getSuperannuationsForHttpResponse(String accessToken, String xeroTenantId, Integer page) throws IOException {
        // verify the required parameter 'xeroTenantId' is set
        if (xeroTenantId == null) {
            throw new IllegalArgumentException("Missing the required parameter 'xeroTenantId' when calling getSuperannuations");
        }
        if (accessToken == null) {
            throw new IllegalArgumentException("Missing the required parameter 'accessToken' when calling getSuperannuations");
        }
        HttpHeaders headers = new HttpHeaders();
        headers.set("Xero-Tenant-Id", xeroTenantId);
        headers.setAccept("application/json"); 
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public Timesheets  getTimesheets(String accessToken, String xeroTenantId, Integer page, String filter, String status, String startDate, String endDate, String sort) throws IOException {
        try {
            ...
            HttpResponse response = getTimesheetsForHttpResponse(accessToken, xeroTenantId, page, filter, status, startDate, endDate, sort);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public TimesheetObject  revertTimesheet(String accessToken, String xeroTenantId, UUID timesheetID, String idempotencyKey) throws IOException {
        try {
            TypeReference<TimesheetObject> typeRef = new TypeReference<TimesheetObject>() {};
            HttpResponse response = revertTimesheetForHttpResponse(accessToken, xeroTenantId, timesheetID, idempotencyKey);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public EmployeeObject  updateEmployee(String accessToken, String xeroTenantId, UUID employeeID, Employee employee, String idempotencyKey) throws IOException {
        try {
            TypeReference<EmployeeObject> typeRef = new TypeReference<EmployeeObject>() {};
            HttpResponse response = updateEmployeeForHttpResponse(accessToken, xeroTenantId, employeeID, employee, idempotencyKey);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public EarningsTemplateObject  updateEmployeeEarningsTemplate(String accessToken, String xeroTenantId, UUID employeeID, UUID payTemplateEarningID, EarningsTemplate earningsTemplate, String idempotencyKey) throws IOException {
        try {
            TypeReference<EarningsTemplateObject> typeRef = new TypeReference<EarningsTemplateObject>() {};
            HttpResponse response = updateEmployeeEarningsTemplateForHttpResponse(accessToken, xeroTenantId, employeeID, payTemplateEarningID, earningsTemplate, idempotencyKey);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public EmployeeLeaveObject  updateEmployeeLeave(String accessToken, String xeroTenantId, UUID employeeID, UUID leaveID, EmployeeLeave employeeLeave, String idempotencyKey) throws IOException {
        try {
            TypeReference<EmployeeLeaveObject> typeRef = new TypeReference<EmployeeLeaveObject>() {};
            HttpResponse response = updateEmployeeLeaveForHttpResponse(accessToken, xeroTenantId, employeeID, leaveID, employeeLeave, idempotencyKey);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public SalaryAndWageObject  updateEmployeeSalaryAndWage(String accessToken, String xeroTenantId, UUID employeeID, UUID salaryAndWagesID, SalaryAndWage salaryAndWage, String idempotencyKey) throws IOException {
        try {
            TypeReference<SalaryAndWageObject> typeRef = new TypeReference<SalaryAndWageObject>() {};
            HttpResponse response = updateEmployeeSalaryAndWageForHttpResponse(accessToken, xeroTenantId, employeeID, salaryAndWagesID, salaryAndWage, idempotencyKey);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
    ...
    * @return  EmployeeTaxObject
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public EmployeeTaxObject  updateEmployeeTax(String accessToken, String xeroTenantId, UUID employeeID, EmployeeTax employeeTax, String idempotencyKey) throws IOException {
        try {
            TypeReference<EmployeeTaxObject> typeRef = new TypeReference<EmployeeTaxObject>() {};
            HttpResponse response = updateEmployeeTaxForHttpResponse(accessToken, xeroTenantId, employeeID, employeeTax, idempotencyKey);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
                logger.debug("------------------ HttpResponseException " + e.getStatusCode() + " : updateEmployeeTax -------------------");
                logger.debug(e.toString());
            }
            XeroApiExceptionHandler handler = new XeroApiExceptionHandler();
             if (e.getStatusCode() == 400 || e.getStatusCode() == 405) {
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public HttpResponse updateEmployeeTaxForHttpResponse(String accessToken, String xeroTenantId, UUID employeeID, EmployeeTax employeeTax, String idempotencyKey) throws IOException {
        // verify the required parameter 'xeroTenantId' is set
        if (xeroTenantId == null) {
            throw new IllegalArgumentException("Missing the required parameter 'xeroTenantId' when calling updateEmployeeTax");
        }// verify the required parameter 'employeeID' is set
        if (employeeID == null) {
            throw new IllegalArgumentException("Missing the required parameter 'employeeID' when calling updateEmployeeTax");
        }// verify the required parameter 'employeeTax' is set
        if (employeeTax == null) {
            throw new IllegalArgumentException("Missing the required parameter 'employeeTax' when calling updateEmployeeTax");
        }
        if (accessToken == null) {
            throw new IllegalArgumentException("Missing the required parameter 'accessToken' when calling updateEmployeeTax");
        }
        HttpHeaders headers = new HttpHeaders();
        headers.set("Xero-Tenant-Id", xeroTenantId);
        headers.set("Idempotency-Key", idempotencyKey);
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public PayRunObject  updatePayRun(String accessToken, String xeroTenantId, UUID payRunID, PayRun payRun, String idempotencyKey) throws IOException {
        try {
            TypeReference<PayRunObject> typeRef = new TypeReference<PayRunObject>() {};
            HttpResponse response = updatePayRunForHttpResponse(accessToken, xeroTenantId, payRunID, payRun, idempotencyKey);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
    ...
    * @return  PaySlipObject
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public PaySlipObject  updatePaySlipLineItems(String accessToken, String xeroTenantId, UUID paySlipID, PaySlip paySlip, String idempotencyKey) throws IOException {
        try {
            TypeReference<PaySlipObject> typeRef = new TypeReference<PaySlipObject>() {};
            HttpResponse response = updatePaySlipLineItemsForHttpResponse(accessToken, xeroTenantId, paySlipID, paySlip, idempotencyKey);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
                logger.debug("------------------ HttpResponseException " + e.getStatusCode() + " : updatePaySlipLineItems -------------------");
                logger.debug(e.toString());
            }
            XeroApiExceptionHandler handler = new XeroApiExceptionHandler();
             if (e.getStatusCode() == 400 || e.getStatusCode() == 405) {
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public HttpResponse updatePaySlipLineItemsForHttpResponse(String accessToken, String xeroTenantId, UUID paySlipID, PaySlip paySlip, String idempotencyKey) throws IOException {
        // verify the required parameter 'xeroTenantId' is set
        if (xeroTenantId == null) {
            throw new IllegalArgumentException("Missing the required parameter 'xeroTenantId' when calling updatePaySlipLineItems");
        }// verify the required parameter 'paySlipID' is set
        if (paySlipID == null) {
            throw new IllegalArgumentException("Missing the required parameter 'paySlipID' when calling updatePaySlipLineItems");
        }// verify the required parameter 'paySlip' is set
        if (paySlip == null) {
            throw new IllegalArgumentException("Missing the required parameter 'paySlip' when calling updatePaySlipLineItems");
        }
        if (accessToken == null) {
            throw new IllegalArgumentException("Missing the required parameter 'accessToken' when calling updatePaySlipLineItems");
        }
        HttpHeaders headers = new HttpHeaders();
        headers.set("Xero-Tenant-Id", xeroTenantId);
        headers.set("Idempotency-Key", idempotencyKey);
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public TimesheetLineObject  updateTimesheetLine(String accessToken, String xeroTenantId, UUID timesheetID, UUID timesheetLineID, TimesheetLine timesheetLine, String idempotencyKey) throws IOException {
        try {
            TypeReference<TimesheetLineObject> typeRef = new TypeReference<TimesheetLineObject>() {};
            HttpResponse response = updateTimesheetLineForHttpResponse(accessToken, xeroTenantId, timesheetID, timesheetLineID, timesheetLine, idempotencyKey);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
