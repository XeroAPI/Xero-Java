...
public class PayrollNzApi {
  ...
  public EmployeeWorkingPatternWithWorkingWeeksObject createEmployeeWorkingPattern(
      ...
      throws IOException {
    try {
      TypeReference<EmployeeWorkingPatternWithWorkingWeeksObject> typeRef =
          new TypeReference<EmployeeWorkingPatternWithWorkingWeeksObject>() {};
      HttpResponse response =
      ...
      XeroApiExceptionHandler handler = new XeroApiExceptionHandler();
      if (e.getStatusCode() == 400 || e.getStatusCode() == 405) {
        TypeReference<EmployeeWorkingPatternWithWorkingWeeksObject> errorTypeRef =
            new TypeReference<EmployeeWorkingPatternWithWorkingWeeksObject>() {};
   ...
   * @throws IOException if an error occurs while attempting to invoke the API *
   */
  public EmployeeWorkingPatternWithWorkingWeeksObject getEmployeeWorkingPattern(
      String accessToken, String xeroTenantId, UUID employeeID, UUID employeeWorkingPatternID)
      throws IOException {
    try {
      TypeReference<EmployeeWorkingPatternWithWorkingWeeksObject> typeRef =
          new TypeReference<EmployeeWorkingPatternWithWorkingWeeksObject>() {};
      HttpResponse response =
          getEmployeeWorkingPatternForHttpResponse(
              accessToken, xeroTenantId, employeeID, employeeWorkingPatternID);
      return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    } catch (HttpResponseException e) {
      if (logger.isDebugEnabled()) {
   ...
   * @throws IOException if an error occurs while attempting to invoke the API
   */
  public HttpResponse getEmployeeWorkingPatternForHttpResponse(
      String accessToken, String xeroTenantId, UUID employeeID, UUID employeeWorkingPatternID)
      throws IOException {
    // verify the required parameter 'xeroTenantId' is set
    if (xeroTenantId == null) {
      throw new IllegalArgumentException(
          "Missing the required parameter 'xeroTenantId' when calling getEmployeeWorkingPattern");
    } // verify the required parameter 'employeeID' is set
    if (employeeID == null) {
      throw new IllegalArgumentException(
          "Missing the required parameter 'employeeID' when calling getEmployeeWorkingPattern");
    } // verify the required parameter 'employeeWorkingPatternID' is set
    if (employeeWorkingPatternID == null) {
      throw new IllegalArgumentException(
          "Missing the required parameter 'employeeWorkingPatternID' when calling"
    ...
    if (accessToken == null) {
      throw new IllegalArgumentException(
          "Missing the required parameter 'accessToken' when calling getEmployeeWorkingPattern");
    }
    HttpHeaders headers = new HttpHeaders();
    headers.set("Xero-Tenant-Id", xeroTenantId);
    headers.setAccept("application/json");
  ...
  public EmployeeWorkingPatternsObject getEmployeeWorkingPatterns(
      String accessToken, String xeroTenantId, UUID employeeID) throws IOException {
    try {
      TypeReference<EmployeeWorkingPatternsObject> typeRef =
          new TypeReference<EmployeeWorkingPatternsObject>() {};
      HttpResponse response =
          getEmployeeWorkingPatternsForHttpResponse(accessToken, xeroTenantId, employeeID);
      return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    } catch (HttpResponseException e) {
      if (logger.isDebugEnabled()) {
        logger.debug(
      ...
      XeroApiExceptionHandler handler = new XeroApiExceptionHandler();
      if (e.getStatusCode() == 400 || e.getStatusCode() == 405) {
        TypeReference<EmployeeWorkingPatternsObject> errorTypeRef =
            new TypeReference<EmployeeWorkingPatternsObject>() {};
        EmployeeWorkingPatternsObject object =
            apiClient.getObjectMapper().readValue(e.getContent(), errorTypeRef);
        handler.validationError(
            e.getStatusCode(), "EmployeeWorkingPatternsObject", object.getProblem(), e);
      } else {
        handler.execute(e);
      }
    } catch (IOException ioe) {
   ...
   * @throws IOException if an error occurs while attempting to invoke the API
   */
  public HttpResponse getEmployeeWorkingPatternsForHttpResponse(
      String accessToken, String xeroTenantId, UUID employeeID) throws IOException {
    // verify the required parameter 'xeroTenantId' is set
    if (xeroTenantId == null) {
      throw new IllegalArgumentException(
          "Missing the required parameter 'xeroTenantId' when calling getEmployeeWorkingPatterns");
    } // verify the required parameter 'employeeID' is set
    if (employeeID == null) {
      throw new IllegalArgumentException(
          "Missing the required parameter 'employeeID' when calling getEmployeeWorkingPatterns");
    }
    if (accessToken == null) {
      throw new IllegalArgumentException(
          "Missing the required parameter 'accessToken' when calling getEmployeeWorkingPatterns");
    }
    HttpHeaders headers = new HttpHeaders();
    headers.set("Xero-Tenant-Id", xeroTenantId);
    headers.setAccept("application/json");
    ...
    try {
      ...
      HttpResponse response =
          updateEmployeeTaxForHttpResponse(
              accessToken, xeroTenantId, employeeID, employeeTax, idempotencyKey);
      return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    } catch (HttpResponseException e) {
      if (logger.isDebugEnabled()) {
        logger.debug(
    ...
    try {
      ...
      HttpResponse response =
          updatePaySlipLineItemsForHttpResponse(
              accessToken, xeroTenantId, paySlipID, paySlip, idempotencyKey);
      return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    } catch (HttpResponseException e) {
      if (logger.isDebugEnabled()) {
        logger.debug(
