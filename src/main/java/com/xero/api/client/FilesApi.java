...
public class FilesApi {
    ...
    * @return  Files
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public Files  getFiles(String accessToken, String xeroTenantId, Integer pagesize, Integer page, String sort, String direction) throws IOException {
        try {
            TypeReference<Files> typeRef = new TypeReference<Files>() {};
            HttpResponse response = getFilesForHttpResponse(accessToken, xeroTenantId, pagesize, page, sort, direction);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public HttpResponse getFilesForHttpResponse(String accessToken, String xeroTenantId, Integer pagesize, Integer page, String sort, String direction) throws IOException {
        // verify the required parameter 'xeroTenantId' is set
        if (xeroTenantId == null) {
