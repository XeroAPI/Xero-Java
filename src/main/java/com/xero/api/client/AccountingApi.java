...
public class AccountingApi {
  ...
  /**
    ...
    **/
    public Accounts  createAccount(Account account) throws IOException {
        HttpResponse response = createAccountForHttpResponse(account);
        TypeReference typeRef = new TypeReference<Accounts>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createAccountForHttpResponse( Account account) throws IOException {
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public Attachments  createAccountAttachmentByFileName(UUID accountID, String fileName, File body) throws IOException {
        HttpResponse response = createAccountAttachmentByFileNameForHttpResponse(accountID, fileName, body);
        TypeReference typeRef = new TypeReference<Attachments>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createAccountAttachmentByFileNameForHttpResponse( UUID accountID,  String fileName, File  body) throws IOException {
  ...
  /**
    ...
    **/
    public BankTransactions  createBankTransaction(BankTransactions bankTransactions, Boolean summarizeErrors) throws IOException {
        HttpResponse response = createBankTransactionForHttpResponse(bankTransactions, summarizeErrors);
        TypeReference typeRef = new TypeReference<BankTransactions>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createBankTransactionForHttpResponse( BankTransactions bankTransactions,  Boolean summarizeErrors) throws IOException {
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public Attachments  createBankTransactionAttachmentByFileName(UUID bankTransactionID, String fileName, File body) throws IOException {
        HttpResponse response = createBankTransactionAttachmentByFileNameForHttpResponse(bankTransactionID, fileName, body);
        TypeReference typeRef = new TypeReference<Attachments>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createBankTransactionAttachmentByFileNameForHttpResponse( UUID bankTransactionID,  String fileName, File  body) throws IOException {
  ...
  /**
    ...
    **/
    public HistoryRecords  createBankTransactionHistoryRecord(UUID bankTransactionID, HistoryRecords historyRecords) throws IOException {
        HttpResponse response = createBankTransactionHistoryRecordForHttpResponse(bankTransactionID, historyRecords);
        TypeReference typeRef = new TypeReference<HistoryRecords>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createBankTransactionHistoryRecordForHttpResponse( UUID bankTransactionID,  HistoryRecords historyRecords) throws IOException {
        // verify the required parameter 'bankTransactionID' is set
        if (bankTransactionID == null) {
  ...
  /**
    ...
    **/
    public BankTransfers  createBankTransfer(BankTransfers bankTransfers) throws IOException {
        HttpResponse response = createBankTransferForHttpResponse(bankTransfers);
        TypeReference typeRef = new TypeReference<BankTransfers>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createBankTransferForHttpResponse( BankTransfers bankTransfers) throws IOException {
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public Attachments  createBankTransferAttachmentByFileName(UUID bankTransferID, String fileName, File body) throws IOException {
        HttpResponse response = createBankTransferAttachmentByFileNameForHttpResponse(bankTransferID, fileName, body);
        TypeReference typeRef = new TypeReference<Attachments>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createBankTransferAttachmentByFileNameForHttpResponse( UUID bankTransferID,  String fileName, File  body) throws IOException {
  ...
  /**
    ...
    **/
    public HistoryRecords  createBankTransferHistoryRecord(UUID bankTransferID, HistoryRecords historyRecords) throws IOException {
        HttpResponse response = createBankTransferHistoryRecordForHttpResponse(bankTransferID, historyRecords);
        TypeReference typeRef = new TypeReference<HistoryRecords>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createBankTransferHistoryRecordForHttpResponse( UUID bankTransferID,  HistoryRecords historyRecords) throws IOException {
        // verify the required parameter 'bankTransferID' is set
        if (bankTransferID == null) {
  ...
  /**
    ...
    **/
    public BatchPayments  createBatchPayment(BatchPayments batchPayments) throws IOException {
        HttpResponse response = createBatchPaymentForHttpResponse(batchPayments);
        TypeReference typeRef = new TypeReference<BatchPayments>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createBatchPaymentForHttpResponse( BatchPayments batchPayments) throws IOException {
  ...
  /**
    ...
    **/
    public HistoryRecords  createBatchPaymentHistoryRecord(UUID batchPaymentID, HistoryRecords historyRecords) throws IOException {
        HttpResponse response = createBatchPaymentHistoryRecordForHttpResponse(batchPaymentID, historyRecords);
        TypeReference typeRef = new TypeReference<HistoryRecords>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createBatchPaymentHistoryRecordForHttpResponse( UUID batchPaymentID,  HistoryRecords historyRecords) throws IOException {
  ...
  /**
    ...
    **/
    public PaymentServices  createBrandingThemePaymentServices(UUID brandingThemeID, PaymentService paymentService) throws IOException {
        HttpResponse response = createBrandingThemePaymentServicesForHttpResponse(brandingThemeID, paymentService);
        TypeReference typeRef = new TypeReference<PaymentServices>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createBrandingThemePaymentServicesForHttpResponse( UUID brandingThemeID,  PaymentService paymentService) throws IOException {
  ...
  /**
    ...
    **/
    public Contacts  createContact(Contact contact) throws IOException {
        HttpResponse response = createContactForHttpResponse(contact);
        TypeReference typeRef = new TypeReference<Contacts>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createContactForHttpResponse( Contact contact) throws IOException {
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public Attachments  createContactAttachmentByFileName(UUID contactID, String fileName, File body) throws IOException {
        HttpResponse response = createContactAttachmentByFileNameForHttpResponse(contactID, fileName, body);
        TypeReference typeRef = new TypeReference<Attachments>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createContactAttachmentByFileNameForHttpResponse( UUID contactID,  String fileName, File  body) throws IOException {
  ...
  /**
    ...
    **/
    public ContactGroups  createContactGroup(ContactGroups contactGroups) throws IOException {
        HttpResponse response = createContactGroupForHttpResponse(contactGroups);
        TypeReference typeRef = new TypeReference<ContactGroups>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createContactGroupForHttpResponse( ContactGroups contactGroups) throws IOException {
  ...
  /**
    ...
    **/
    public Contacts  createContactGroupContacts(UUID contactGroupID, Contacts contacts) throws IOException {
        HttpResponse response = createContactGroupContactsForHttpResponse(contactGroupID, contacts);
        TypeReference typeRef = new TypeReference<Contacts>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createContactGroupContactsForHttpResponse( UUID contactGroupID,  Contacts contacts) throws IOException {
  ...
  /**
    ...
    **/
    public HistoryRecords  createContactHistory(UUID contactID, HistoryRecords historyRecords) throws IOException {
        HttpResponse response = createContactHistoryForHttpResponse(contactID, historyRecords);
        TypeReference typeRef = new TypeReference<HistoryRecords>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createContactHistoryForHttpResponse( UUID contactID,  HistoryRecords historyRecords) throws IOException {
        // verify the required parameter 'contactID' is set
        if (contactID == null) {
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public CreditNotes  createCreditNote(CreditNotes creditNotes, Boolean summarizeErrors) throws IOException {
        HttpResponse response = createCreditNoteForHttpResponse(creditNotes, summarizeErrors);
        TypeReference typeRef = new TypeReference<CreditNotes>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createCreditNoteForHttpResponse( CreditNotes creditNotes,  Boolean summarizeErrors) throws IOException {
  ...
  /**
    ...
    **/
    public Allocations  createCreditNoteAllocation(UUID creditNoteID, Allocations allocations) throws IOException {
        HttpResponse response = createCreditNoteAllocationForHttpResponse(creditNoteID, allocations);
        TypeReference typeRef = new TypeReference<Allocations>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createCreditNoteAllocationForHttpResponse( UUID creditNoteID,  Allocations allocations) throws IOException {
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public Attachments  createCreditNoteAttachmentByFileName(UUID creditNoteID, String fileName, File body) throws IOException {
        HttpResponse response = createCreditNoteAttachmentByFileNameForHttpResponse(creditNoteID, fileName, body);
        TypeReference typeRef = new TypeReference<Attachments>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createCreditNoteAttachmentByFileNameForHttpResponse( UUID creditNoteID,  String fileName, File  body) throws IOException {
        // verify the required parameter 'creditNoteID' is set
        if (creditNoteID == null) {
  ...
  /**
    ...
    **/
    public HistoryRecords  createCreditNoteHistory(UUID creditNoteID, HistoryRecords historyRecords) throws IOException {
        HttpResponse response = createCreditNoteHistoryForHttpResponse(creditNoteID, historyRecords);
        TypeReference typeRef = new TypeReference<HistoryRecords>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createCreditNoteHistoryForHttpResponse( UUID creditNoteID,  HistoryRecords historyRecords) throws IOException {
        // verify the required parameter 'creditNoteID' is set
        if (creditNoteID == null) {
  ...
  /**
    ...
    **/
    public Currencies  createCurrency(Currencies currencies) throws IOException {
        HttpResponse response = createCurrencyForHttpResponse(currencies);
        TypeReference typeRef = new TypeReference<Currencies>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createCurrencyForHttpResponse( Currencies currencies) throws IOException {
  ...
  /**
    ...
    **/
    public Employees  createEmployee(Employees employees) throws IOException {
        HttpResponse response = createEmployeeForHttpResponse(employees);
        TypeReference typeRef = new TypeReference<Employees>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createEmployeeForHttpResponse( Employees employees) throws IOException {
  ...
  /**
    ...
    **/
    public ExpenseClaims  createExpenseClaim(ExpenseClaims expenseClaims, Boolean summarizeErrors) throws IOException {
        HttpResponse response = createExpenseClaimForHttpResponse(expenseClaims, summarizeErrors);
        TypeReference typeRef = new TypeReference<ExpenseClaims>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createExpenseClaimForHttpResponse( ExpenseClaims expenseClaims,  Boolean summarizeErrors) throws IOException {
  ...
  /**
    ...
    **/
    public HistoryRecords  createExpenseClaimHistory(UUID expenseClaimID, HistoryRecords historyRecords) throws IOException {
        HttpResponse response = createExpenseClaimHistoryForHttpResponse(expenseClaimID, historyRecords);
        TypeReference typeRef = new TypeReference<HistoryRecords>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createExpenseClaimHistoryForHttpResponse( UUID expenseClaimID,  HistoryRecords historyRecords) throws IOException {
  ...
  /**
    ...
    **/
    public Invoices  createInvoice(Invoices invoices, Boolean summarizeErrors) throws IOException {
        HttpResponse response = createInvoiceForHttpResponse(invoices, summarizeErrors);
        TypeReference typeRef = new TypeReference<Invoices>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createInvoiceForHttpResponse( Invoices invoices,  Boolean summarizeErrors) throws IOException {
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public Attachments  createInvoiceAttachmentByFileName(UUID invoiceID, String fileName, File body) throws IOException {
        HttpResponse response = createInvoiceAttachmentByFileNameForHttpResponse(invoiceID, fileName, body);
        TypeReference typeRef = new TypeReference<Attachments>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createInvoiceAttachmentByFileNameForHttpResponse( UUID invoiceID,  String fileName, File  body) throws IOException {
  ...
  /**
    ...
    **/
    public HistoryRecords  createInvoiceHistory(UUID invoiceID, HistoryRecords historyRecords) throws IOException {
        HttpResponse response = createInvoiceHistoryForHttpResponse(invoiceID, historyRecords);
        TypeReference typeRef = new TypeReference<HistoryRecords>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createInvoiceHistoryForHttpResponse( UUID invoiceID,  HistoryRecords historyRecords) throws IOException {
        // verify the required parameter 'invoiceID' is set
        if (invoiceID == null) {
  ...
  /**
    ...
    **/
    public Items  createItem(Items items) throws IOException {
        HttpResponse response = createItemForHttpResponse(items);
        TypeReference typeRef = new TypeReference<Items>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createItemForHttpResponse( Items items) throws IOException {
  ...
  /**
    ...
    **/
    public HistoryRecords  createItemHistory(UUID itemID, HistoryRecords historyRecords) throws IOException {
        HttpResponse response = createItemHistoryForHttpResponse(itemID, historyRecords);
        TypeReference typeRef = new TypeReference<HistoryRecords>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createItemHistoryForHttpResponse( UUID itemID,  HistoryRecords historyRecords) throws IOException {
  ...
  /**
    ...
    **/
    public LinkedTransactions  createLinkedTransaction(LinkedTransactions linkedTransactions) throws IOException {
        HttpResponse response = createLinkedTransactionForHttpResponse(linkedTransactions);
        TypeReference typeRef = new TypeReference<LinkedTransactions>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createLinkedTransactionForHttpResponse( LinkedTransactions linkedTransactions) throws IOException {
  ...
  /**
    ...
    **/
    public ManualJournals  createManualJournal(ManualJournals manualJournals) throws IOException {
        HttpResponse response = createManualJournalForHttpResponse(manualJournals);
        TypeReference typeRef = new TypeReference<ManualJournals>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createManualJournalForHttpResponse( ManualJournals manualJournals) throws IOException {
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public Attachments  createManualJournalAttachmentByFileName(UUID manualJournalID, String fileName, File body) throws IOException {
        HttpResponse response = createManualJournalAttachmentByFileNameForHttpResponse(manualJournalID, fileName, body);
        TypeReference typeRef = new TypeReference<Attachments>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createManualJournalAttachmentByFileNameForHttpResponse( UUID manualJournalID,  String fileName, File  body) throws IOException {
  ...
  /**
    ...
    **/
    public Allocations  createOverpaymentAllocation(UUID overpaymentID, Allocations allocations) throws IOException {
        HttpResponse response = createOverpaymentAllocationForHttpResponse(overpaymentID, allocations);
        TypeReference typeRef = new TypeReference<Allocations>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createOverpaymentAllocationForHttpResponse( UUID overpaymentID,  Allocations allocations) throws IOException {
  ...
  /**
    ...
    **/
    public HistoryRecords  createOverpaymentHistory(UUID overpaymentID, HistoryRecords historyRecords) throws IOException {
        HttpResponse response = createOverpaymentHistoryForHttpResponse(overpaymentID, historyRecords);
        TypeReference typeRef = new TypeReference<HistoryRecords>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createOverpaymentHistoryForHttpResponse( UUID overpaymentID,  HistoryRecords historyRecords) throws IOException {
        // verify the required parameter 'overpaymentID' is set
        if (overpaymentID == null) {
  ...
  /**
    ...
    **/
    public Payments  createPayment(Payments payments) throws IOException {
        HttpResponse response = createPaymentForHttpResponse(payments);
        TypeReference typeRef = new TypeReference<Payments>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createPaymentForHttpResponse( Payments payments) throws IOException {
  ...
  /**
    ...
    **/
    public HistoryRecords  createPaymentHistory(UUID paymentID, HistoryRecords historyRecords) throws IOException {
        HttpResponse response = createPaymentHistoryForHttpResponse(paymentID, historyRecords);
        TypeReference typeRef = new TypeReference<HistoryRecords>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createPaymentHistoryForHttpResponse( UUID paymentID,  HistoryRecords historyRecords) throws IOException {
  ...
  /**
    ...
    **/
    public PaymentServices  createPaymentService(PaymentServices paymentServices) throws IOException {
        HttpResponse response = createPaymentServiceForHttpResponse(paymentServices);
        TypeReference typeRef = new TypeReference<PaymentServices>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createPaymentServiceForHttpResponse( PaymentServices paymentServices) throws IOException {
  ...
  /**
    ...
    **/
    public Allocations  createPrepaymentAllocation(UUID prepaymentID, Allocations allocations) throws IOException {
        HttpResponse response = createPrepaymentAllocationForHttpResponse(prepaymentID, allocations);
        TypeReference typeRef = new TypeReference<Allocations>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createPrepaymentAllocationForHttpResponse( UUID prepaymentID,  Allocations allocations) throws IOException {
  ...
  /**
    ...
    **/
    public HistoryRecords  createPrepaymentHistory(UUID prepaymentID, HistoryRecords historyRecords) throws IOException {
        HttpResponse response = createPrepaymentHistoryForHttpResponse(prepaymentID, historyRecords);
        TypeReference typeRef = new TypeReference<HistoryRecords>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createPrepaymentHistoryForHttpResponse( UUID prepaymentID,  HistoryRecords historyRecords) throws IOException {
        // verify the required parameter 'prepaymentID' is set
        if (prepaymentID == null) {
  ...
  /**
    ...
    **/
    public PurchaseOrders  createPurchaseOrder(PurchaseOrders purchaseOrders, Boolean summarizeErrors) throws IOException {
        HttpResponse response = createPurchaseOrderForHttpResponse(purchaseOrders, summarizeErrors);
        TypeReference typeRef = new TypeReference<PurchaseOrders>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createPurchaseOrderForHttpResponse( PurchaseOrders purchaseOrders,  Boolean summarizeErrors) throws IOException {
  ...
  /**
    ...
    **/
    public HistoryRecords  createPurchaseOrderHistory(UUID purchaseOrderID, HistoryRecords historyRecords) throws IOException {
        HttpResponse response = createPurchaseOrderHistoryForHttpResponse(purchaseOrderID, historyRecords);
        TypeReference typeRef = new TypeReference<HistoryRecords>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createPurchaseOrderHistoryForHttpResponse( UUID purchaseOrderID,  HistoryRecords historyRecords) throws IOException {
  ...
  /**
    ...
    **/
    public Receipts  createReceipt(Receipts receipts) throws IOException {
        HttpResponse response = createReceiptForHttpResponse(receipts);
        TypeReference typeRef = new TypeReference<Receipts>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createReceiptForHttpResponse( Receipts receipts) throws IOException {
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public Attachments  createReceiptAttachmentByFileName(UUID receiptID, String fileName, File body) throws IOException {
        HttpResponse response = createReceiptAttachmentByFileNameForHttpResponse(receiptID, fileName, body);
        TypeReference typeRef = new TypeReference<Attachments>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createReceiptAttachmentByFileNameForHttpResponse( UUID receiptID,  String fileName, File  body) throws IOException {
  ...
  /**
    ...
    **/
    public HistoryRecords  createReceiptHistory(UUID receiptID, HistoryRecords historyRecords) throws IOException {
        HttpResponse response = createReceiptHistoryForHttpResponse(receiptID, historyRecords);
        TypeReference typeRef = new TypeReference<HistoryRecords>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createReceiptHistoryForHttpResponse( UUID receiptID,  HistoryRecords historyRecords) throws IOException {
        // verify the required parameter 'receiptID' is set
        if (receiptID == null) {
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public Attachments  createRepeatingInvoiceAttachmentByFileName(UUID repeatingInvoiceID, String fileName, File body) throws IOException {
        HttpResponse response = createRepeatingInvoiceAttachmentByFileNameForHttpResponse(repeatingInvoiceID, fileName, body);
        TypeReference typeRef = new TypeReference<Attachments>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createRepeatingInvoiceAttachmentByFileNameForHttpResponse( UUID repeatingInvoiceID,  String fileName, File  body) throws IOException {
  ...
  /**
    ...
    **/
    public HistoryRecords  createRepeatingInvoiceHistory(UUID repeatingInvoiceID, HistoryRecords historyRecords) throws IOException {
        HttpResponse response = createRepeatingInvoiceHistoryForHttpResponse(repeatingInvoiceID, historyRecords);
        TypeReference typeRef = new TypeReference<HistoryRecords>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createRepeatingInvoiceHistoryForHttpResponse( UUID repeatingInvoiceID,  HistoryRecords historyRecords) throws IOException {
        // verify the required parameter 'repeatingInvoiceID' is set
        if (repeatingInvoiceID == null) {
  ...
  /**
    ...
    **/
    public TaxRates  createTaxRate(TaxRates taxRates) throws IOException {
        HttpResponse response = createTaxRateForHttpResponse(taxRates);
        TypeReference typeRef = new TypeReference<TaxRates>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createTaxRateForHttpResponse( TaxRates taxRates) throws IOException {
  ...
  /**
    ...
    **/
    public TrackingCategories  createTrackingCategory(TrackingCategory trackingCategory) throws IOException {
        HttpResponse response = createTrackingCategoryForHttpResponse(trackingCategory);
        TypeReference typeRef = new TypeReference<TrackingCategories>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createTrackingCategoryForHttpResponse( TrackingCategory trackingCategory) throws IOException {
  ...
  /**
    ...
    **/
    public TrackingOptions  createTrackingOptions(UUID trackingCategoryID, TrackingOption trackingOption) throws IOException {
        HttpResponse response = createTrackingOptionsForHttpResponse(trackingCategoryID, trackingOption);
        TypeReference typeRef = new TypeReference<TrackingOptions>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse createTrackingOptionsForHttpResponse( UUID trackingCategoryID,  TrackingOption trackingOption) throws IOException {
  ...
  /**
    ...
    **/
    public Accounts  deleteAccount(UUID accountID) throws IOException {
        HttpResponse response = deleteAccountForHttpResponse(accountID);
        TypeReference typeRef = new TypeReference<Accounts>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse deleteAccountForHttpResponse( UUID accountID) throws IOException {
        // verify the required parameter 'accountID' is set
        if (accountID == null) {
  ...
  /**
    ...
    **/
    public void deleteContactGroupContact(UUID contactGroupID, UUID contactID) throws IOException {
        deleteContactGroupContactForHttpResponse(contactGroupID, contactID);
    }

    public HttpResponse deleteContactGroupContactForHttpResponse( UUID contactGroupID,  UUID contactID) throws IOException {
        // verify the required parameter 'contactGroupID' is set
        if (contactGroupID == null) {
  ...
  /**
    ...
    **/
    public void deleteContactGroupContacts(UUID contactGroupID) throws IOException {
        deleteContactGroupContactsForHttpResponse(contactGroupID);
    }

    public HttpResponse deleteContactGroupContactsForHttpResponse( UUID contactGroupID) throws IOException {
        // verify the required parameter 'contactGroupID' is set
        if (contactGroupID == null) {
  ...
  /**
    ...
    **/
    public void deleteItem(UUID itemID) throws IOException {
        deleteItemForHttpResponse(itemID);
    }

    public HttpResponse deleteItemForHttpResponse( UUID itemID) throws IOException {
        // verify the required parameter 'itemID' is set
        if (itemID == null) {
  ...
  /**
    ...
    **/
    public void deleteLinkedTransaction(UUID linkedTransactionID) throws IOException {
        deleteLinkedTransactionForHttpResponse(linkedTransactionID);
    }

    public HttpResponse deleteLinkedTransactionForHttpResponse( UUID linkedTransactionID) throws IOException {
  ...
  /**
    ...
    **/
    public Payments  deletePayment(UUID paymentID, Payments payments) throws IOException {
        HttpResponse response = deletePaymentForHttpResponse(paymentID, payments);
        TypeReference typeRef = new TypeReference<Payments>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse deletePaymentForHttpResponse( UUID paymentID,  Payments payments) throws IOException {
        // verify the required parameter 'paymentID' is set
        if (paymentID == null) {
  ...
  /**
    ...
    **/
    public TrackingCategories  deleteTrackingCategory(UUID trackingCategoryID) throws IOException {
        HttpResponse response = deleteTrackingCategoryForHttpResponse(trackingCategoryID);
        TypeReference typeRef = new TypeReference<TrackingCategories>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse deleteTrackingCategoryForHttpResponse( UUID trackingCategoryID) throws IOException {
        // verify the required parameter 'trackingCategoryID' is set
        if (trackingCategoryID == null) {
  ...
  /**
    ...
    **/
    public TrackingOptions  deleteTrackingOptions(UUID trackingCategoryID, UUID trackingOptionID) throws IOException {
        HttpResponse response = deleteTrackingOptionsForHttpResponse(trackingCategoryID, trackingOptionID);
        TypeReference typeRef = new TypeReference<TrackingOptions>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse deleteTrackingOptionsForHttpResponse( UUID trackingCategoryID,  UUID trackingOptionID) throws IOException {
        // verify the required parameter 'trackingCategoryID' is set
        if (trackingCategoryID == null) {
  ...
  /**
    ...
    **/
    public void emailInvoice(UUID invoiceID, RequestEmpty requestEmpty) throws IOException {
        emailInvoiceForHttpResponse(invoiceID, requestEmpty);
    }

    public HttpResponse emailInvoiceForHttpResponse( UUID invoiceID,  RequestEmpty requestEmpty) throws IOException {
        // verify the required parameter 'invoiceID' is set
        if (invoiceID == null) {
  ...
  /**
    ...
    **/
    public ByteArrayInputStream  getAccountAttachmentByFileName(UUID accountID, String fileName, String contentType) throws IOException {
        HttpResponse response = getAccountAttachmentByFileNameForHttpResponse(accountID, fileName, contentType);
        InputStream is = response.getContent();
        return convertInputToByteArray(is);
        
    }

    public HttpResponse getAccountAttachmentByFileNameForHttpResponse( UUID accountID,  String fileName,  String contentType) throws IOException {
        // verify the required parameter 'accountID' is set
        if (accountID == null) {
  ...
  /**
    ...
    **/
    public ByteArrayInputStream  getAccountAttachmentById(UUID accountID, UUID attachmentID, String contentType) throws IOException {
        HttpResponse response = getAccountAttachmentByIdForHttpResponse(accountID, attachmentID, contentType);
        InputStream is = response.getContent();
        return convertInputToByteArray(is);
        
    }

    public HttpResponse getAccountAttachmentByIdForHttpResponse( UUID accountID,  UUID attachmentID,  String contentType) throws IOException {
        // verify the required parameter 'accountID' is set
        if (accountID == null) {
  ...
  /**
    ...
    **/
    public Attachments  getAccountAttachments(UUID accountID) throws IOException {
        HttpResponse response = getAccountAttachmentsForHttpResponse(accountID);
        TypeReference typeRef = new TypeReference<Attachments>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getAccountAttachmentsForHttpResponse( UUID accountID) throws IOException {
        // verify the required parameter 'accountID' is set
        if (accountID == null) {
  ...
  /**
    ...
    **/
    public Accounts  getAccounts(OffsetDateTime ifModifiedSince, String where, String order) throws IOException {
        HttpResponse response = getAccountsForHttpResponse(ifModifiedSince, where, order);
        TypeReference typeRef = new TypeReference<Accounts>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getAccountsForHttpResponse( OffsetDateTime ifModifiedSince,  String where,  String order) throws IOException {
  ...
  /**
    ...
    **/
    public BankTransactions  getBankTransaction(UUID bankTransactionID) throws IOException {
        HttpResponse response = getBankTransactionForHttpResponse(bankTransactionID);
        TypeReference typeRef = new TypeReference<BankTransactions>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getBankTransactionForHttpResponse( UUID bankTransactionID) throws IOException {
        // verify the required parameter 'bankTransactionID' is set
        if (bankTransactionID == null) {
  ...
  /**
    ...
    **/
    public ByteArrayInputStream  getBankTransactionAttachmentByFileName(UUID bankTransactionID, String fileName, String contentType) throws IOException {
        HttpResponse response = getBankTransactionAttachmentByFileNameForHttpResponse(bankTransactionID, fileName, contentType);
        InputStream is = response.getContent();
        return convertInputToByteArray(is);
        
    }

    public HttpResponse getBankTransactionAttachmentByFileNameForHttpResponse( UUID bankTransactionID,  String fileName,  String contentType) throws IOException {
        // verify the required parameter 'bankTransactionID' is set
        if (bankTransactionID == null) {
  ...
  /**
    ...
    **/
    public ByteArrayInputStream  getBankTransactionAttachmentById(UUID bankTransactionID, UUID attachmentID, String contentType) throws IOException {
        HttpResponse response = getBankTransactionAttachmentByIdForHttpResponse(bankTransactionID, attachmentID, contentType);
        InputStream is = response.getContent();
        return convertInputToByteArray(is);
        
    }

    public HttpResponse getBankTransactionAttachmentByIdForHttpResponse( UUID bankTransactionID,  UUID attachmentID,  String contentType) throws IOException {
        // verify the required parameter 'bankTransactionID' is set
        if (bankTransactionID == null) {
  ...
  /**
    ...
    **/
    public Attachments  getBankTransactionAttachments(UUID bankTransactionID) throws IOException {
        HttpResponse response = getBankTransactionAttachmentsForHttpResponse(bankTransactionID);
        TypeReference typeRef = new TypeReference<Attachments>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getBankTransactionAttachmentsForHttpResponse( UUID bankTransactionID) throws IOException {
        // verify the required parameter 'bankTransactionID' is set
        if (bankTransactionID == null) {
  ...
  /**
    ...
    **/
    public BankTransactions  getBankTransactions(OffsetDateTime ifModifiedSince, String where, String order, Integer page, Integer unitdp) throws IOException {
        HttpResponse response = getBankTransactionsForHttpResponse(ifModifiedSince, where, order, page, unitdp);
        TypeReference typeRef = new TypeReference<BankTransactions>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getBankTransactionsForHttpResponse( OffsetDateTime ifModifiedSince,  String where,  String order,  Integer page,  Integer unitdp) throws IOException {
  ...
  /**
    ...
    **/
    public HistoryRecords  getBankTransactionsHistory(UUID bankTransactionID) throws IOException {
        HttpResponse response = getBankTransactionsHistoryForHttpResponse(bankTransactionID);
        TypeReference typeRef = new TypeReference<HistoryRecords>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getBankTransactionsHistoryForHttpResponse( UUID bankTransactionID) throws IOException {
        // verify the required parameter 'bankTransactionID' is set
        if (bankTransactionID == null) {
  ...
  /**
    ...
    **/
    public BankTransfers  getBankTransfer(UUID bankTransferID) throws IOException {
        HttpResponse response = getBankTransferForHttpResponse(bankTransferID);
        TypeReference typeRef = new TypeReference<BankTransfers>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getBankTransferForHttpResponse( UUID bankTransferID) throws IOException {
        // verify the required parameter 'bankTransferID' is set
        if (bankTransferID == null) {
  ...
  /**
    ...
    **/
    public ByteArrayInputStream  getBankTransferAttachmentByFileName(UUID bankTransferID, String fileName, String contentType) throws IOException {
        HttpResponse response = getBankTransferAttachmentByFileNameForHttpResponse(bankTransferID, fileName, contentType);
        InputStream is = response.getContent();
        return convertInputToByteArray(is);
        
    }

    public HttpResponse getBankTransferAttachmentByFileNameForHttpResponse( UUID bankTransferID,  String fileName,  String contentType) throws IOException {
        // verify the required parameter 'bankTransferID' is set
        if (bankTransferID == null) {
  ...
  /**
    ...
    **/
    public ByteArrayInputStream  getBankTransferAttachmentById(UUID bankTransferID, UUID attachmentID, String contentType) throws IOException {
        HttpResponse response = getBankTransferAttachmentByIdForHttpResponse(bankTransferID, attachmentID, contentType);
        InputStream is = response.getContent();
        return convertInputToByteArray(is);
        
    }

    public HttpResponse getBankTransferAttachmentByIdForHttpResponse( UUID bankTransferID,  UUID attachmentID,  String contentType) throws IOException {
        // verify the required parameter 'bankTransferID' is set
        if (bankTransferID == null) {
  ...
  /**
    ...
    **/
    public Attachments  getBankTransferAttachments(UUID bankTransferID) throws IOException {
        HttpResponse response = getBankTransferAttachmentsForHttpResponse(bankTransferID);
        TypeReference typeRef = new TypeReference<Attachments>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getBankTransferAttachmentsForHttpResponse( UUID bankTransferID) throws IOException {
        // verify the required parameter 'bankTransferID' is set
        if (bankTransferID == null) {
  ...
  /**
    ...
    **/
    public HistoryRecords  getBankTransferHistory(UUID bankTransferID) throws IOException {
        HttpResponse response = getBankTransferHistoryForHttpResponse(bankTransferID);
        TypeReference typeRef = new TypeReference<HistoryRecords>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getBankTransferHistoryForHttpResponse( UUID bankTransferID) throws IOException {
        // verify the required parameter 'bankTransferID' is set
        if (bankTransferID == null) {
  ...
  /**
    ...
    **/
    public BankTransfers  getBankTransfers(OffsetDateTime ifModifiedSince, String where, String order) throws IOException {
        HttpResponse response = getBankTransfersForHttpResponse(ifModifiedSince, where, order);
        TypeReference typeRef = new TypeReference<BankTransfers>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getBankTransfersForHttpResponse( OffsetDateTime ifModifiedSince,  String where,  String order) throws IOException {
  ...
  /**
    ...
    **/
    public HistoryRecords  getBatchPaymentHistory(UUID batchPaymentID) throws IOException {
        HttpResponse response = getBatchPaymentHistoryForHttpResponse(batchPaymentID);
        TypeReference typeRef = new TypeReference<HistoryRecords>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getBatchPaymentHistoryForHttpResponse( UUID batchPaymentID) throws IOException {
        // verify the required parameter 'batchPaymentID' is set
        if (batchPaymentID == null) {
  ...
  /**
    ...
    **/
    public BatchPayments  getBatchPayments(OffsetDateTime ifModifiedSince, String where, String order) throws IOException {
        HttpResponse response = getBatchPaymentsForHttpResponse(ifModifiedSince, where, order);
        TypeReference typeRef = new TypeReference<BatchPayments>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getBatchPaymentsForHttpResponse( OffsetDateTime ifModifiedSince,  String where,  String order) throws IOException {
  ...
  /**
    ...
    **/
    public BrandingThemes  getBrandingTheme(UUID brandingThemeID) throws IOException {
        HttpResponse response = getBrandingThemeForHttpResponse(brandingThemeID);
        TypeReference typeRef = new TypeReference<BrandingThemes>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getBrandingThemeForHttpResponse( UUID brandingThemeID) throws IOException {
        // verify the required parameter 'brandingThemeID' is set
        if (brandingThemeID == null) {
  ...
  /**
    ...
    **/
    public PaymentServices  getBrandingThemePaymentServices(UUID brandingThemeID) throws IOException {
        HttpResponse response = getBrandingThemePaymentServicesForHttpResponse(brandingThemeID);
        TypeReference typeRef = new TypeReference<PaymentServices>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getBrandingThemePaymentServicesForHttpResponse( UUID brandingThemeID) throws IOException {
        // verify the required parameter 'brandingThemeID' is set
        if (brandingThemeID == null) {
  ...
  /**
    ...
    **/
    public BrandingThemes  getBrandingThemes() throws IOException {
        HttpResponse response = getBrandingThemesForHttpResponse();
        TypeReference typeRef = new TypeReference<BrandingThemes>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getBrandingThemesForHttpResponse() throws IOException {
  ...
  /**
    ...
    **/
    public Contacts  getContact(UUID contactID) throws IOException {
        HttpResponse response = getContactForHttpResponse(contactID);
        TypeReference typeRef = new TypeReference<Contacts>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getContactForHttpResponse( UUID contactID) throws IOException {
        // verify the required parameter 'contactID' is set
        if (contactID == null) {
  ...
  /**
    ...
    **/
    public ByteArrayInputStream  getContactAttachmentByFileName(UUID contactID, String fileName, String contentType) throws IOException {
        HttpResponse response = getContactAttachmentByFileNameForHttpResponse(contactID, fileName, contentType);
        InputStream is = response.getContent();
        return convertInputToByteArray(is);
        
    }

    public HttpResponse getContactAttachmentByFileNameForHttpResponse( UUID contactID,  String fileName,  String contentType) throws IOException {
        // verify the required parameter 'contactID' is set
        if (contactID == null) {
  ...
  /**
    ...
    **/
    public ByteArrayInputStream  getContactAttachmentById(UUID contactID, UUID attachmentID, String contentType) throws IOException {
        HttpResponse response = getContactAttachmentByIdForHttpResponse(contactID, attachmentID, contentType);
        InputStream is = response.getContent();
        return convertInputToByteArray(is);
        
    }

    public HttpResponse getContactAttachmentByIdForHttpResponse( UUID contactID,  UUID attachmentID,  String contentType) throws IOException {
        // verify the required parameter 'contactID' is set
        if (contactID == null) {
  ...
  /**
    ...
    **/
    public Attachments  getContactAttachments(UUID contactID) throws IOException {
        HttpResponse response = getContactAttachmentsForHttpResponse(contactID);
        TypeReference typeRef = new TypeReference<Attachments>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getContactAttachmentsForHttpResponse( UUID contactID) throws IOException {
        // verify the required parameter 'contactID' is set
        if (contactID == null) {
  ...
  /**
    ...
    **/
    public CISSettings  getContactCISSettings(UUID contactID) throws IOException {
        HttpResponse response = getContactCISSettingsForHttpResponse(contactID);
        TypeReference typeRef = new TypeReference<CISSettings>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getContactCISSettingsForHttpResponse( UUID contactID) throws IOException {
        // verify the required parameter 'contactID' is set
        if (contactID == null) {
  ...
  /**
    ...
    **/
    public ContactGroups  getContactGroup(UUID contactGroupID) throws IOException {
        HttpResponse response = getContactGroupForHttpResponse(contactGroupID);
        TypeReference typeRef = new TypeReference<ContactGroups>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getContactGroupForHttpResponse( UUID contactGroupID) throws IOException {
        // verify the required parameter 'contactGroupID' is set
        if (contactGroupID == null) {
  ...
  /**
    ...
    **/
    public ContactGroups  getContactGroups(String where, String order) throws IOException {
        HttpResponse response = getContactGroupsForHttpResponse(where, order);
        TypeReference typeRef = new TypeReference<ContactGroups>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getContactGroupsForHttpResponse( String where,  String order) throws IOException {
  ...
  /**
    ...
    **/
    public HistoryRecords  getContactHistory(UUID contactID) throws IOException {
        HttpResponse response = getContactHistoryForHttpResponse(contactID);
        TypeReference typeRef = new TypeReference<HistoryRecords>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getContactHistoryForHttpResponse( UUID contactID) throws IOException {
        // verify the required parameter 'contactID' is set
        if (contactID == null) {
  ...
  /**
    ...
    **/
    public Contacts  getContacts(OffsetDateTime ifModifiedSince, String where, String order, String ids, Integer page, Boolean includeArchived) throws IOException {
        HttpResponse response = getContactsForHttpResponse(ifModifiedSince, where, order, ids, page, includeArchived);
        TypeReference typeRef = new TypeReference<Contacts>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getContactsForHttpResponse( OffsetDateTime ifModifiedSince,  String where,  String order,  String ids,  Integer page,  Boolean includeArchived) throws IOException {
  ...
  /**
    ...
    **/
    public CreditNotes  getCreditNote(UUID creditNoteID) throws IOException {
        HttpResponse response = getCreditNoteForHttpResponse(creditNoteID);
        TypeReference typeRef = new TypeReference<CreditNotes>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getCreditNoteForHttpResponse( UUID creditNoteID) throws IOException {
        // verify the required parameter 'creditNoteID' is set
        if (creditNoteID == null) {
  ...
  /**
    ...
    **/
    public ByteArrayInputStream  getCreditNoteAsPdf(UUID creditNoteID, String contentType) throws IOException {
        HttpResponse response = getCreditNoteAsPdfForHttpResponse(creditNoteID, contentType);
        InputStream is = response.getContent();
        return convertInputToByteArray(is);
        
    }

    public HttpResponse getCreditNoteAsPdfForHttpResponse( UUID creditNoteID,  String contentType) throws IOException {
        // verify the required parameter 'creditNoteID' is set
        if (creditNoteID == null) {
  ...
  /**
    ...
    **/
    public ByteArrayInputStream  getCreditNoteAttachmentByFileName(UUID creditNoteID, String fileName, String contentType) throws IOException {
        HttpResponse response = getCreditNoteAttachmentByFileNameForHttpResponse(creditNoteID, fileName, contentType);
        InputStream is = response.getContent();
        return convertInputToByteArray(is);
        
    }

    public HttpResponse getCreditNoteAttachmentByFileNameForHttpResponse( UUID creditNoteID,  String fileName,  String contentType) throws IOException {
        // verify the required parameter 'creditNoteID' is set
        if (creditNoteID == null) {
  ...
  /**
    ...
    **/
    public ByteArrayInputStream  getCreditNoteAttachmentById(UUID creditNoteID, UUID attachmentID, String contentType) throws IOException {
        HttpResponse response = getCreditNoteAttachmentByIdForHttpResponse(creditNoteID, attachmentID, contentType);
        InputStream is = response.getContent();
        return convertInputToByteArray(is);
        
    }

    public HttpResponse getCreditNoteAttachmentByIdForHttpResponse( UUID creditNoteID,  UUID attachmentID,  String contentType) throws IOException {
        // verify the required parameter 'creditNoteID' is set
        if (creditNoteID == null) {
  ...
  /**
    ...
    **/
    public Attachments  getCreditNoteAttachments(UUID creditNoteID) throws IOException {
        HttpResponse response = getCreditNoteAttachmentsForHttpResponse(creditNoteID);
        TypeReference typeRef = new TypeReference<Attachments>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getCreditNoteAttachmentsForHttpResponse( UUID creditNoteID) throws IOException {
        // verify the required parameter 'creditNoteID' is set
        if (creditNoteID == null) {
  ...
  /**
    ...
    **/
    public HistoryRecords  getCreditNoteHistory(UUID creditNoteID) throws IOException {
        HttpResponse response = getCreditNoteHistoryForHttpResponse(creditNoteID);
        TypeReference typeRef = new TypeReference<HistoryRecords>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getCreditNoteHistoryForHttpResponse( UUID creditNoteID) throws IOException {
        // verify the required parameter 'creditNoteID' is set
        if (creditNoteID == null) {
  ...
  /**
    ...
    **/
    public CreditNotes  getCreditNotes(OffsetDateTime ifModifiedSince, String where, String order, Integer page) throws IOException {
        HttpResponse response = getCreditNotesForHttpResponse(ifModifiedSince, where, order, page);
        TypeReference typeRef = new TypeReference<CreditNotes>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getCreditNotesForHttpResponse( OffsetDateTime ifModifiedSince,  String where,  String order,  Integer page) throws IOException {
  ...
  /**
    ...
    **/
    public Currencies  getCurrencies(String where, String order) throws IOException {
        HttpResponse response = getCurrenciesForHttpResponse(where, order);
        TypeReference typeRef = new TypeReference<Currencies>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getCurrenciesForHttpResponse( String where,  String order) throws IOException {
  ...
  /**
    ...
    **/
    public Employees  getEmployee(UUID employeeID) throws IOException {
        HttpResponse response = getEmployeeForHttpResponse(employeeID);
        TypeReference typeRef = new TypeReference<Employees>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getEmployeeForHttpResponse( UUID employeeID) throws IOException {
  ...
  /**
    ...
    **/
    public Employees  getEmployees(OffsetDateTime ifModifiedSince, String where, String order) throws IOException {
        HttpResponse response = getEmployeesForHttpResponse(ifModifiedSince, where, order);
        TypeReference typeRef = new TypeReference<Employees>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getEmployeesForHttpResponse( OffsetDateTime ifModifiedSince,  String where,  String order) throws IOException {
  ...
  /**
    ...
    **/
    public ExpenseClaims  getExpenseClaim(UUID expenseClaimID) throws IOException {
        HttpResponse response = getExpenseClaimForHttpResponse(expenseClaimID);
        TypeReference typeRef = new TypeReference<ExpenseClaims>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getExpenseClaimForHttpResponse( UUID expenseClaimID) throws IOException {
        // verify the required parameter 'expenseClaimID' is set
        if (expenseClaimID == null) {
  ...
  /**
    ...
    **/
    public HistoryRecords  getExpenseClaimHistory(UUID expenseClaimID) throws IOException {
        HttpResponse response = getExpenseClaimHistoryForHttpResponse(expenseClaimID);
        TypeReference typeRef = new TypeReference<HistoryRecords>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getExpenseClaimHistoryForHttpResponse( UUID expenseClaimID) throws IOException {
        // verify the required parameter 'expenseClaimID' is set
        if (expenseClaimID == null) {
  ...
  /**
    ...
    **/
    public ExpenseClaims  getExpenseClaims(OffsetDateTime ifModifiedSince, String where, String order) throws IOException {
        HttpResponse response = getExpenseClaimsForHttpResponse(ifModifiedSince, where, order);
        TypeReference typeRef = new TypeReference<ExpenseClaims>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getExpenseClaimsForHttpResponse( OffsetDateTime ifModifiedSince,  String where,  String order) throws IOException {
  ...
  /**
    ...
    **/
    public Invoices  getInvoice(UUID invoiceID) throws IOException {
        HttpResponse response = getInvoiceForHttpResponse(invoiceID);
        TypeReference typeRef = new TypeReference<Invoices>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getInvoiceForHttpResponse( UUID invoiceID) throws IOException {
        // verify the required parameter 'invoiceID' is set
        if (invoiceID == null) {
  ...
  /**
    ...
    **/
    public ByteArrayInputStream  getInvoiceAsPdf(UUID invoiceID, String contentType) throws IOException {
        HttpResponse response = getInvoiceAsPdfForHttpResponse(invoiceID, contentType);
        InputStream is = response.getContent();
        return convertInputToByteArray(is);
        
    }

    public HttpResponse getInvoiceAsPdfForHttpResponse( UUID invoiceID,  String contentType) throws IOException {
        // verify the required parameter 'invoiceID' is set
        if (invoiceID == null) {
  ...
  /**
    ...
    **/
    public ByteArrayInputStream  getInvoiceAttachmentByFileName(UUID invoiceID, String fileName, String contentType) throws IOException {
        HttpResponse response = getInvoiceAttachmentByFileNameForHttpResponse(invoiceID, fileName, contentType);
        InputStream is = response.getContent();
        return convertInputToByteArray(is);
        
    }

    public HttpResponse getInvoiceAttachmentByFileNameForHttpResponse( UUID invoiceID,  String fileName,  String contentType) throws IOException {
        // verify the required parameter 'invoiceID' is set
        if (invoiceID == null) {
  ...
  /**
    ...
    **/
    public ByteArrayInputStream  getInvoiceAttachmentById(UUID invoiceID, UUID attachmentID, String contentType) throws IOException {
        HttpResponse response = getInvoiceAttachmentByIdForHttpResponse(invoiceID, attachmentID, contentType);
        InputStream is = response.getContent();
        return convertInputToByteArray(is);
        
    }

    public HttpResponse getInvoiceAttachmentByIdForHttpResponse( UUID invoiceID,  UUID attachmentID,  String contentType) throws IOException {
        // verify the required parameter 'invoiceID' is set
        if (invoiceID == null) {
  ...
  /**
    ...
    **/
    public Attachments  getInvoiceAttachments(UUID invoiceID) throws IOException {
        HttpResponse response = getInvoiceAttachmentsForHttpResponse(invoiceID);
        TypeReference typeRef = new TypeReference<Attachments>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getInvoiceAttachmentsForHttpResponse( UUID invoiceID) throws IOException {
        // verify the required parameter 'invoiceID' is set
        if (invoiceID == null) {
  ...
  /**
    ...
    **/
    public HistoryRecords  getInvoiceHistory(UUID invoiceID) throws IOException {
        HttpResponse response = getInvoiceHistoryForHttpResponse(invoiceID);
        TypeReference typeRef = new TypeReference<HistoryRecords>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getInvoiceHistoryForHttpResponse( UUID invoiceID) throws IOException {
        // verify the required parameter 'invoiceID' is set
        if (invoiceID == null) {
  ...
  /**
    ...
    **/
    public InvoiceReminders  getInvoiceReminders() throws IOException {
        HttpResponse response = getInvoiceRemindersForHttpResponse();
        TypeReference typeRef = new TypeReference<InvoiceReminders>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getInvoiceRemindersForHttpResponse() throws IOException {
  ...
  /**
    ...
    **/
    public Invoices  getInvoices(OffsetDateTime ifModifiedSince, String where, String order, String ids, String invoiceNumbers, String contactIDs, String statuses, Integer page, Boolean includeArchived, Boolean createdByMyApp, Integer unitdp) throws IOException {
        HttpResponse response = getInvoicesForHttpResponse(ifModifiedSince, where, order, ids, invoiceNumbers, contactIDs, statuses, page, includeArchived, createdByMyApp, unitdp);
        TypeReference typeRef = new TypeReference<Invoices>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getInvoicesForHttpResponse( OffsetDateTime ifModifiedSince,  String where,  String order,  String ids,  String invoiceNumbers,  String contactIDs,  String statuses,  Integer page,  Boolean includeArchived,  Boolean createdByMyApp,  Integer unitdp) throws IOException {
  ...
  /**
    ...
    **/
    public Items  getItem(UUID itemID) throws IOException {
        HttpResponse response = getItemForHttpResponse(itemID);
        TypeReference typeRef = new TypeReference<Items>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getItemForHttpResponse( UUID itemID) throws IOException {
        // verify the required parameter 'itemID' is set
        if (itemID == null) {
  ...
  /**
    ...
    **/
    public HistoryRecords  getItemHistory(UUID itemID) throws IOException {
        HttpResponse response = getItemHistoryForHttpResponse(itemID);
        TypeReference typeRef = new TypeReference<HistoryRecords>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getItemHistoryForHttpResponse( UUID itemID) throws IOException {
        // verify the required parameter 'itemID' is set
        if (itemID == null) {
  ...
  /**
    ...
    **/
    public Items  getItems(OffsetDateTime ifModifiedSince, String where, String order, Integer unitdp) throws IOException {
        HttpResponse response = getItemsForHttpResponse(ifModifiedSince, where, order, unitdp);
        TypeReference typeRef = new TypeReference<Items>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getItemsForHttpResponse( OffsetDateTime ifModifiedSince,  String where,  String order,  Integer unitdp) throws IOException {
  ...
  /**
    ...
    **/
    public Journals  getJournal(UUID journalID) throws IOException {
        HttpResponse response = getJournalForHttpResponse(journalID);
        TypeReference typeRef = new TypeReference<Journals>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getJournalForHttpResponse( UUID journalID) throws IOException {
  ...
  /**
    ...
    **/
    public Journals  getJournals(OffsetDateTime ifModifiedSince, Integer offset, Boolean paymentsOnly) throws IOException {
        HttpResponse response = getJournalsForHttpResponse(ifModifiedSince, offset, paymentsOnly);
        TypeReference typeRef = new TypeReference<Journals>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getJournalsForHttpResponse( OffsetDateTime ifModifiedSince,  Integer offset,  Boolean paymentsOnly) throws IOException {
  ...
  /**
    ...
    **/
    public LinkedTransactions  getLinkedTransaction(UUID linkedTransactionID) throws IOException {
        HttpResponse response = getLinkedTransactionForHttpResponse(linkedTransactionID);
        TypeReference typeRef = new TypeReference<LinkedTransactions>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getLinkedTransactionForHttpResponse( UUID linkedTransactionID) throws IOException {
        // verify the required parameter 'linkedTransactionID' is set
        if (linkedTransactionID == null) {
  ...
  /**
    ...
    **/
    public LinkedTransactions  getLinkedTransactions(Integer page, String linkedTransactionID, String sourceTransactionID, String contactID, String status, String targetTransactionID) throws IOException {
        HttpResponse response = getLinkedTransactionsForHttpResponse(page, linkedTransactionID, sourceTransactionID, contactID, status, targetTransactionID);
        TypeReference typeRef = new TypeReference<LinkedTransactions>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getLinkedTransactionsForHttpResponse( Integer page,  String linkedTransactionID,  String sourceTransactionID,  String contactID,  String status,  String targetTransactionID) throws IOException {
  ...
  /**
    ...
    **/
    public ManualJournals  getManualJournal(UUID manualJournalID) throws IOException {
        HttpResponse response = getManualJournalForHttpResponse(manualJournalID);
        TypeReference typeRef = new TypeReference<ManualJournals>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getManualJournalForHttpResponse( UUID manualJournalID) throws IOException {
        // verify the required parameter 'manualJournalID' is set
        if (manualJournalID == null) {
  ...
  /**
    ...
    **/
    public ByteArrayInputStream  getManualJournalAttachmentByFileName(UUID manualJournalID, String fileName, String contentType) throws IOException {
        HttpResponse response = getManualJournalAttachmentByFileNameForHttpResponse(manualJournalID, fileName, contentType);
        InputStream is = response.getContent();
        return convertInputToByteArray(is);
        
    }

    public HttpResponse getManualJournalAttachmentByFileNameForHttpResponse( UUID manualJournalID,  String fileName,  String contentType) throws IOException {
        // verify the required parameter 'manualJournalID' is set
        if (manualJournalID == null) {
  ...
  /**
    ...
    **/
    public ByteArrayInputStream  getManualJournalAttachmentById(UUID manualJournalID, UUID attachmentID, String contentType) throws IOException {
        HttpResponse response = getManualJournalAttachmentByIdForHttpResponse(manualJournalID, attachmentID, contentType);
        InputStream is = response.getContent();
        return convertInputToByteArray(is);
        
    }

    public HttpResponse getManualJournalAttachmentByIdForHttpResponse( UUID manualJournalID,  UUID attachmentID,  String contentType) throws IOException {
        // verify the required parameter 'manualJournalID' is set
        if (manualJournalID == null) {
  ...
  /**
    ...
    **/
    public Attachments  getManualJournalAttachments(UUID manualJournalID) throws IOException {
        HttpResponse response = getManualJournalAttachmentsForHttpResponse(manualJournalID);
        TypeReference typeRef = new TypeReference<Attachments>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getManualJournalAttachmentsForHttpResponse( UUID manualJournalID) throws IOException {
        // verify the required parameter 'manualJournalID' is set
        if (manualJournalID == null) {
  ...
  /**
    ...
    **/
    public ManualJournals  getManualJournals(OffsetDateTime ifModifiedSince, String where, String order, Integer page) throws IOException {
        HttpResponse response = getManualJournalsForHttpResponse(ifModifiedSince, where, order, page);
        TypeReference typeRef = new TypeReference<ManualJournals>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getManualJournalsForHttpResponse( OffsetDateTime ifModifiedSince,  String where,  String order,  Integer page) throws IOException {
  ...
  /**
    ...
    **/
    public OnlineInvoices  getOnlineInvoice(UUID invoiceID) throws IOException {
        HttpResponse response = getOnlineInvoiceForHttpResponse(invoiceID);
        TypeReference typeRef = new TypeReference<OnlineInvoices>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getOnlineInvoiceForHttpResponse( UUID invoiceID) throws IOException {
        // verify the required parameter 'invoiceID' is set
        if (invoiceID == null) {
  ...
  /**
    ...
    **/
    public CISOrgSetting  getOrganisationCISSettings(UUID organisationID) throws IOException {
        HttpResponse response = getOrganisationCISSettingsForHttpResponse(organisationID);
        TypeReference typeRef = new TypeReference<CISOrgSetting>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getOrganisationCISSettingsForHttpResponse( UUID organisationID) throws IOException {
  ...
  /**
    ...
    **/
    public Organisations  getOrganisations() throws IOException {
        HttpResponse response = getOrganisationsForHttpResponse();
        TypeReference typeRef = new TypeReference<Organisations>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getOrganisationsForHttpResponse() throws IOException {
  ...
  /**
    ...
    **/
    public Overpayments  getOverpayment(UUID overpaymentID) throws IOException {
        HttpResponse response = getOverpaymentForHttpResponse(overpaymentID);
        TypeReference typeRef = new TypeReference<Overpayments>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getOverpaymentForHttpResponse( UUID overpaymentID) throws IOException {
        // verify the required parameter 'overpaymentID' is set
        if (overpaymentID == null) {
  ...
  /**
    ...
    **/
    public HistoryRecords  getOverpaymentHistory(UUID overpaymentID) throws IOException {
        HttpResponse response = getOverpaymentHistoryForHttpResponse(overpaymentID);
        TypeReference typeRef = new TypeReference<HistoryRecords>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getOverpaymentHistoryForHttpResponse( UUID overpaymentID) throws IOException {
        // verify the required parameter 'overpaymentID' is set
        if (overpaymentID == null) {
  ...
  /**
    ...
    **/
    public Overpayments  getOverpayments(OffsetDateTime ifModifiedSince, String where, String order, Integer page, Integer unitdp) throws IOException {
        HttpResponse response = getOverpaymentsForHttpResponse(ifModifiedSince, where, order, page, unitdp);
        TypeReference typeRef = new TypeReference<Overpayments>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getOverpaymentsForHttpResponse( OffsetDateTime ifModifiedSince,  String where,  String order,  Integer page,  Integer unitdp) throws IOException {
  ...
  /**
    ...
    **/
    public Payments  getPayment(UUID paymentID) throws IOException {
        HttpResponse response = getPaymentForHttpResponse(paymentID);
        TypeReference typeRef = new TypeReference<Payments>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getPaymentForHttpResponse( UUID paymentID) throws IOException {
        // verify the required parameter 'paymentID' is set
        if (paymentID == null) {
  ...
  /**
    ...
    **/
    public HistoryRecords  getPaymentHistory(UUID paymentID) throws IOException {
        HttpResponse response = getPaymentHistoryForHttpResponse(paymentID);
        TypeReference typeRef = new TypeReference<HistoryRecords>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getPaymentHistoryForHttpResponse( UUID paymentID) throws IOException {
        // verify the required parameter 'paymentID' is set
        if (paymentID == null) {
  ...
  /**
    ...
    **/
    public PaymentServices  getPaymentServices() throws IOException {
        HttpResponse response = getPaymentServicesForHttpResponse();
        TypeReference typeRef = new TypeReference<PaymentServices>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getPaymentServicesForHttpResponse() throws IOException {
  ...
  /**
    ...
    **/
    public Payments  getPayments(OffsetDateTime ifModifiedSince, String where, String order) throws IOException {
        HttpResponse response = getPaymentsForHttpResponse(ifModifiedSince, where, order);
        TypeReference typeRef = new TypeReference<Payments>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getPaymentsForHttpResponse( OffsetDateTime ifModifiedSince,  String where,  String order) throws IOException {
  ...
  /**
    ...
    **/
    public Prepayments  getPrepayment(UUID prepaymentID) throws IOException {
        HttpResponse response = getPrepaymentForHttpResponse(prepaymentID);
        TypeReference typeRef = new TypeReference<Prepayments>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getPrepaymentForHttpResponse( UUID prepaymentID) throws IOException {
        // verify the required parameter 'prepaymentID' is set
        if (prepaymentID == null) {
  ...
  /**
    ...
    **/
    public HistoryRecords  getPrepaymentHistory(UUID prepaymentID) throws IOException {
        HttpResponse response = getPrepaymentHistoryForHttpResponse(prepaymentID);
        TypeReference typeRef = new TypeReference<HistoryRecords>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getPrepaymentHistoryForHttpResponse( UUID prepaymentID) throws IOException {
        // verify the required parameter 'prepaymentID' is set
        if (prepaymentID == null) {
  ...
  /**
    ...
    **/
    public Prepayments  getPrepayments(OffsetDateTime ifModifiedSince, String where, String order, Integer page, Integer unitdp) throws IOException {
        HttpResponse response = getPrepaymentsForHttpResponse(ifModifiedSince, where, order, page, unitdp);
        TypeReference typeRef = new TypeReference<Prepayments>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getPrepaymentsForHttpResponse( OffsetDateTime ifModifiedSince,  String where,  String order,  Integer page,  Integer unitdp) throws IOException {
  ...
  /**
    ...
    **/
    public PurchaseOrders  getPurchaseOrder(UUID purchaseOrderID) throws IOException {
        HttpResponse response = getPurchaseOrderForHttpResponse(purchaseOrderID);
        TypeReference typeRef = new TypeReference<PurchaseOrders>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getPurchaseOrderForHttpResponse( UUID purchaseOrderID) throws IOException {
        // verify the required parameter 'purchaseOrderID' is set
        if (purchaseOrderID == null) {
  ...
  /**
    ...
    **/
    public HistoryRecords  getPurchaseOrderHistory(UUID purchaseOrderID) throws IOException {
        HttpResponse response = getPurchaseOrderHistoryForHttpResponse(purchaseOrderID);
        TypeReference typeRef = new TypeReference<HistoryRecords>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getPurchaseOrderHistoryForHttpResponse( UUID purchaseOrderID) throws IOException {
        // verify the required parameter 'purchaseOrderID' is set
        if (purchaseOrderID == null) {
  ...
  /**
    ...
    **/
    public PurchaseOrders  getPurchaseOrders(OffsetDateTime ifModifiedSince, String status, String dateFrom, String dateTo, String order, Integer page) throws IOException {
        HttpResponse response = getPurchaseOrdersForHttpResponse(ifModifiedSince, status, dateFrom, dateTo, order, page);
        TypeReference typeRef = new TypeReference<PurchaseOrders>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getPurchaseOrdersForHttpResponse( OffsetDateTime ifModifiedSince,  String status,  String dateFrom,  String dateTo,  String order,  Integer page) throws IOException {
  ...
  /**
    ...
    **/
    public Receipts  getReceipt(UUID receiptID) throws IOException {
        HttpResponse response = getReceiptForHttpResponse(receiptID);
        TypeReference typeRef = new TypeReference<Receipts>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getReceiptForHttpResponse( UUID receiptID) throws IOException {
        // verify the required parameter 'receiptID' is set
        if (receiptID == null) {
  ...
  /**
    ...
    **/
    public ByteArrayInputStream  getReceiptAttachmentByFileName(UUID receiptID, String fileName, String contentType) throws IOException {
        HttpResponse response = getReceiptAttachmentByFileNameForHttpResponse(receiptID, fileName, contentType);
        InputStream is = response.getContent();
        return convertInputToByteArray(is);
        
    }

    public HttpResponse getReceiptAttachmentByFileNameForHttpResponse( UUID receiptID,  String fileName,  String contentType) throws IOException {
        // verify the required parameter 'receiptID' is set
        if (receiptID == null) {
  ...
  /**
    ...
    **/
    public ByteArrayInputStream  getReceiptAttachmentById(UUID receiptID, UUID attachmentID, String contentType) throws IOException {
        HttpResponse response = getReceiptAttachmentByIdForHttpResponse(receiptID, attachmentID, contentType);
        InputStream is = response.getContent();
        return convertInputToByteArray(is);
        
    }

    public HttpResponse getReceiptAttachmentByIdForHttpResponse( UUID receiptID,  UUID attachmentID,  String contentType) throws IOException {
        // verify the required parameter 'receiptID' is set
        if (receiptID == null) {
  ...
  /**
    ...
    **/
    public Attachments  getReceiptAttachments(UUID receiptID) throws IOException {
        HttpResponse response = getReceiptAttachmentsForHttpResponse(receiptID);
        TypeReference typeRef = new TypeReference<Attachments>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getReceiptAttachmentsForHttpResponse( UUID receiptID) throws IOException {
        // verify the required parameter 'receiptID' is set
        if (receiptID == null) {
  ...
  /**
    ...
    **/
    public HistoryRecords  getReceiptHistory(UUID receiptID) throws IOException {
        HttpResponse response = getReceiptHistoryForHttpResponse(receiptID);
        TypeReference typeRef = new TypeReference<HistoryRecords>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getReceiptHistoryForHttpResponse( UUID receiptID) throws IOException {
        // verify the required parameter 'receiptID' is set
        if (receiptID == null) {
  ...
  /**
    ...
    **/
    public Receipts  getReceipts(OffsetDateTime ifModifiedSince, String where, String order, Integer unitdp) throws IOException {
        HttpResponse response = getReceiptsForHttpResponse(ifModifiedSince, where, order, unitdp);
        TypeReference typeRef = new TypeReference<Receipts>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getReceiptsForHttpResponse( OffsetDateTime ifModifiedSince,  String where,  String order,  Integer unitdp) throws IOException {
  ...
  /**
    ...
    **/
    public RepeatingInvoices  getRepeatingInvoice(UUID repeatingInvoiceID) throws IOException {
        HttpResponse response = getRepeatingInvoiceForHttpResponse(repeatingInvoiceID);
        TypeReference typeRef = new TypeReference<RepeatingInvoices>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getRepeatingInvoiceForHttpResponse( UUID repeatingInvoiceID) throws IOException {
        // verify the required parameter 'repeatingInvoiceID' is set
        if (repeatingInvoiceID == null) {
  ...
  /**
    ...
    **/
    public ByteArrayInputStream  getRepeatingInvoiceAttachmentByFileName(UUID repeatingInvoiceID, String fileName, String contentType) throws IOException {
        HttpResponse response = getRepeatingInvoiceAttachmentByFileNameForHttpResponse(repeatingInvoiceID, fileName, contentType);
        InputStream is = response.getContent();
        return convertInputToByteArray(is);
        
    }

    public HttpResponse getRepeatingInvoiceAttachmentByFileNameForHttpResponse( UUID repeatingInvoiceID,  String fileName,  String contentType) throws IOException {
        // verify the required parameter 'repeatingInvoiceID' is set
        if (repeatingInvoiceID == null) {
  ...
  /**
    ...
    **/
    public ByteArrayInputStream  getRepeatingInvoiceAttachmentById(UUID repeatingInvoiceID, UUID attachmentID, String contentType) throws IOException {
        HttpResponse response = getRepeatingInvoiceAttachmentByIdForHttpResponse(repeatingInvoiceID, attachmentID, contentType);
        InputStream is = response.getContent();
        return convertInputToByteArray(is);
        
    }

    public HttpResponse getRepeatingInvoiceAttachmentByIdForHttpResponse( UUID repeatingInvoiceID,  UUID attachmentID,  String contentType) throws IOException {
        // verify the required parameter 'repeatingInvoiceID' is set
        if (repeatingInvoiceID == null) {
  ...
  /**
    ...
    **/
    public Attachments  getRepeatingInvoiceAttachments(UUID repeatingInvoiceID) throws IOException {
        HttpResponse response = getRepeatingInvoiceAttachmentsForHttpResponse(repeatingInvoiceID);
        TypeReference typeRef = new TypeReference<Attachments>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getRepeatingInvoiceAttachmentsForHttpResponse( UUID repeatingInvoiceID) throws IOException {
        // verify the required parameter 'repeatingInvoiceID' is set
        if (repeatingInvoiceID == null) {
  ...
  /**
    ...
    **/
    public HistoryRecords  getRepeatingInvoiceHistory(UUID repeatingInvoiceID) throws IOException {
        HttpResponse response = getRepeatingInvoiceHistoryForHttpResponse(repeatingInvoiceID);
        TypeReference typeRef = new TypeReference<HistoryRecords>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getRepeatingInvoiceHistoryForHttpResponse( UUID repeatingInvoiceID) throws IOException {
        // verify the required parameter 'repeatingInvoiceID' is set
        if (repeatingInvoiceID == null) {
  ...
  /**
    ...
    **/
    public RepeatingInvoices  getRepeatingInvoices(String where, String order) throws IOException {
        HttpResponse response = getRepeatingInvoicesForHttpResponse(where, order);
        TypeReference typeRef = new TypeReference<RepeatingInvoices>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getRepeatingInvoicesForHttpResponse( String where,  String order) throws IOException {
  ...
  /**
    ...
    **/
    public ReportWithRows  getReportAgedPayablesByContact(UUID contactId, LocalDate date, LocalDate fromDate, LocalDate toDate) throws IOException {
        HttpResponse response = getReportAgedPayablesByContactForHttpResponse(contactId, date, fromDate, toDate);
        TypeReference typeRef = new TypeReference<ReportWithRows>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getReportAgedPayablesByContactForHttpResponse( UUID contactId,  LocalDate date,  LocalDate fromDate,  LocalDate toDate) throws IOException {
        // verify the required parameter 'contactId' is set
        if (contactId == null) {
  ...
  /**
    ...
    **/
    public ReportWithRows  getReportAgedReceivablesByContact(UUID contactId, LocalDate date, LocalDate fromDate, LocalDate toDate) throws IOException {
        HttpResponse response = getReportAgedReceivablesByContactForHttpResponse(contactId, date, fromDate, toDate);
        TypeReference typeRef = new TypeReference<ReportWithRows>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getReportAgedReceivablesByContactForHttpResponse( UUID contactId,  LocalDate date,  LocalDate fromDate,  LocalDate toDate) throws IOException {
        // verify the required parameter 'contactId' is set
        if (contactId == null) {
  ...
  /**
    ...
    **/
    public ReportWithRows  getReportBASorGST(String reportID) throws IOException {
        HttpResponse response = getReportBASorGSTForHttpResponse(reportID);
        TypeReference typeRef = new TypeReference<ReportWithRows>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getReportBASorGSTForHttpResponse( String reportID) throws IOException {
  ...
  /**
    ...
    **/
    public ReportWithRows  getReportBASorGSTList() throws IOException {
        HttpResponse response = getReportBASorGSTListForHttpResponse();
        TypeReference typeRef = new TypeReference<ReportWithRows>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getReportBASorGSTListForHttpResponse() throws IOException {
  ...
  /**
    ...
    **/
    public ReportWithRows  getReportBalanceSheet(String date, Integer periods, String timeframe, String trackingOptionID1, String trackingOptionID2, Boolean standardLayout, Boolean paymentsOnly) throws IOException {
        HttpResponse response = getReportBalanceSheetForHttpResponse(date, periods, timeframe, trackingOptionID1, trackingOptionID2, standardLayout, paymentsOnly);
        TypeReference typeRef = new TypeReference<ReportWithRows>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getReportBalanceSheetForHttpResponse( String date,  Integer periods,  String timeframe,  String trackingOptionID1,  String trackingOptionID2,  Boolean standardLayout,  Boolean paymentsOnly) throws IOException {
  ...
  /**
    ...
    **/
    public ReportWithRows  getReportBankSummary(LocalDate date, Integer period, Integer timeframe) throws IOException {
        HttpResponse response = getReportBankSummaryForHttpResponse(date, period, timeframe);
        TypeReference typeRef = new TypeReference<ReportWithRows>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getReportBankSummaryForHttpResponse( LocalDate date,  Integer period,  Integer timeframe) throws IOException {
  ...
  /**
    ...
    **/
    public ReportWithRows  getReportBudgetSummary(LocalDate date, Integer period, Integer timeframe) throws IOException {
        HttpResponse response = getReportBudgetSummaryForHttpResponse(date, period, timeframe);
        TypeReference typeRef = new TypeReference<ReportWithRows>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getReportBudgetSummaryForHttpResponse( LocalDate date,  Integer period,  Integer timeframe) throws IOException {
  ...
  /**
    ...
    **/
    public ReportWithRows  getReportExecutiveSummary(LocalDate date) throws IOException {
        HttpResponse response = getReportExecutiveSummaryForHttpResponse(date);
        TypeReference typeRef = new TypeReference<ReportWithRows>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getReportExecutiveSummaryForHttpResponse( LocalDate date) throws IOException {
  ...
  /**
    ...
    **/
    public ReportWithRows  getReportProfitAndLoss(LocalDate fromDate, LocalDate toDate, Integer periods, String timeframe, String trackingCategoryID, String trackingCategoryID2, String trackingOptionID, String trackingOptionID2, Boolean standardLayout, Boolean paymentsOnly) throws IOException {
        HttpResponse response = getReportProfitAndLossForHttpResponse(fromDate, toDate, periods, timeframe, trackingCategoryID, trackingCategoryID2, trackingOptionID, trackingOptionID2, standardLayout, paymentsOnly);
        TypeReference typeRef = new TypeReference<ReportWithRows>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getReportProfitAndLossForHttpResponse( LocalDate fromDate,  LocalDate toDate,  Integer periods,  String timeframe,  String trackingCategoryID,  String trackingCategoryID2,  String trackingOptionID,  String trackingOptionID2,  Boolean standardLayout,  Boolean paymentsOnly) throws IOException {
  ...
  /**
    ...
    **/
    public Reports  getReportTenNinetyNine(String reportYear) throws IOException {
        HttpResponse response = getReportTenNinetyNineForHttpResponse(reportYear);
        TypeReference typeRef = new TypeReference<Reports>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getReportTenNinetyNineForHttpResponse( String reportYear) throws IOException {
  ...
  /**
    ...
    **/
    public ReportWithRows  getReportTrialBalance(LocalDate date, Boolean paymentsOnly) throws IOException {
        HttpResponse response = getReportTrialBalanceForHttpResponse(date, paymentsOnly);
        TypeReference typeRef = new TypeReference<ReportWithRows>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getReportTrialBalanceForHttpResponse( LocalDate date,  Boolean paymentsOnly) throws IOException {
  ...
  /**
    ...
    **/
    public TaxRates  getTaxRates(String where, String order, String taxType) throws IOException {
        HttpResponse response = getTaxRatesForHttpResponse(where, order, taxType);
        TypeReference typeRef = new TypeReference<TaxRates>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getTaxRatesForHttpResponse( String where,  String order,  String taxType) throws IOException {
  ...
  /**
    ...
    **/
    public TrackingCategories  getTrackingCategories(String where, String order, Boolean includeArchived) throws IOException {
        HttpResponse response = getTrackingCategoriesForHttpResponse(where, order, includeArchived);
        TypeReference typeRef = new TypeReference<TrackingCategories>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getTrackingCategoriesForHttpResponse( String where,  String order,  Boolean includeArchived) throws IOException {
  ...
  /**
    ...
    **/
    public TrackingCategories  getTrackingCategory(UUID trackingCategoryID) throws IOException {
        HttpResponse response = getTrackingCategoryForHttpResponse(trackingCategoryID);
        TypeReference typeRef = new TypeReference<TrackingCategories>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getTrackingCategoryForHttpResponse( UUID trackingCategoryID) throws IOException {
        // verify the required parameter 'trackingCategoryID' is set
        if (trackingCategoryID == null) {
  ...
  /**
    ...
    **/
    public Users  getUser(UUID userID) throws IOException {
        HttpResponse response = getUserForHttpResponse(userID);
        TypeReference typeRef = new TypeReference<Users>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getUserForHttpResponse( UUID userID) throws IOException {
  ...
  /**
    ...
    **/
    public Users  getUsers(OffsetDateTime ifModifiedSince, String where, String order) throws IOException {
        HttpResponse response = getUsersForHttpResponse(ifModifiedSince, where, order);
        TypeReference typeRef = new TypeReference<Users>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse getUsersForHttpResponse( OffsetDateTime ifModifiedSince,  String where,  String order) throws IOException {
  ...
  /**
    ...
    **/
    public Accounts  updateAccount(UUID accountID, Accounts accounts) throws IOException {
        HttpResponse response = updateAccountForHttpResponse(accountID, accounts);
        TypeReference typeRef = new TypeReference<Accounts>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse updateAccountForHttpResponse( UUID accountID,  Accounts accounts) throws IOException {
        // verify the required parameter 'accountID' is set
        if (accountID == null) {
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public Attachments  updateAccountAttachmentByFileName(UUID accountID, String fileName, File body) throws IOException {
        HttpResponse response = updateAccountAttachmentByFileNameForHttpResponse(accountID, fileName, body);
        TypeReference typeRef = new TypeReference<Attachments>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse updateAccountAttachmentByFileNameForHttpResponse( UUID accountID,  String fileName, File  body) throws IOException {
        // verify the required parameter 'accountID' is set
        if (accountID == null) {
  ...
  /**
    ...
    **/
    public BankTransactions  updateBankTransaction(UUID bankTransactionID, BankTransactions bankTransactions) throws IOException {
        HttpResponse response = updateBankTransactionForHttpResponse(bankTransactionID, bankTransactions);
        TypeReference typeRef = new TypeReference<BankTransactions>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse updateBankTransactionForHttpResponse( UUID bankTransactionID,  BankTransactions bankTransactions) throws IOException {
        // verify the required parameter 'bankTransactionID' is set
        if (bankTransactionID == null) {
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public Attachments  updateBankTransactionAttachmentByFileName(UUID bankTransactionID, String fileName, File body) throws IOException {
        HttpResponse response = updateBankTransactionAttachmentByFileNameForHttpResponse(bankTransactionID, fileName, body);
        TypeReference typeRef = new TypeReference<Attachments>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse updateBankTransactionAttachmentByFileNameForHttpResponse( UUID bankTransactionID,  String fileName, File  body) throws IOException {
        // verify the required parameter 'bankTransactionID' is set
        if (bankTransactionID == null) {
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public Attachments  updateBankTransferAttachmentByFileName(UUID bankTransferID, String fileName, File body) throws IOException {
        HttpResponse response = updateBankTransferAttachmentByFileNameForHttpResponse(bankTransferID, fileName, body);
        TypeReference typeRef = new TypeReference<Attachments>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse updateBankTransferAttachmentByFileNameForHttpResponse( UUID bankTransferID,  String fileName, File  body) throws IOException {
        // verify the required parameter 'bankTransferID' is set
        if (bankTransferID == null) {
  ...
  /**
    ...
    **/
    public Contacts  updateContact(UUID contactID, Contacts contacts) throws IOException {
        HttpResponse response = updateContactForHttpResponse(contactID, contacts);
        TypeReference typeRef = new TypeReference<Contacts>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse updateContactForHttpResponse( UUID contactID,  Contacts contacts) throws IOException {
        // verify the required parameter 'contactID' is set
        if (contactID == null) {
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public Attachments  updateContactAttachmentByFileName(UUID contactID, String fileName, File body) throws IOException {
        HttpResponse response = updateContactAttachmentByFileNameForHttpResponse(contactID, fileName, body);
        TypeReference typeRef = new TypeReference<Attachments>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse updateContactAttachmentByFileNameForHttpResponse( UUID contactID,  String fileName, File  body) throws IOException {
        // verify the required parameter 'contactID' is set
        if (contactID == null) {
  ...
  /**
    ...
    **/
    public ContactGroups  updateContactGroup(UUID contactGroupID, ContactGroups contactGroups) throws IOException {
        HttpResponse response = updateContactGroupForHttpResponse(contactGroupID, contactGroups);
        TypeReference typeRef = new TypeReference<ContactGroups>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse updateContactGroupForHttpResponse( UUID contactGroupID,  ContactGroups contactGroups) throws IOException {
        // verify the required parameter 'contactGroupID' is set
        if (contactGroupID == null) {
  ...
  /**
    ...
    **/
    public CreditNotes  updateCreditNote(UUID creditNoteID, CreditNotes creditNotes) throws IOException {
        HttpResponse response = updateCreditNoteForHttpResponse(creditNoteID, creditNotes);
        TypeReference typeRef = new TypeReference<CreditNotes>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse updateCreditNoteForHttpResponse( UUID creditNoteID,  CreditNotes creditNotes) throws IOException {
        // verify the required parameter 'creditNoteID' is set
        if (creditNoteID == null) {
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public Attachments  updateCreditNoteAttachmentByFileName(UUID creditNoteID, String fileName, File body) throws IOException {
        HttpResponse response = updateCreditNoteAttachmentByFileNameForHttpResponse(creditNoteID, fileName, body);
        TypeReference typeRef = new TypeReference<Attachments>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse updateCreditNoteAttachmentByFileNameForHttpResponse( UUID creditNoteID,  String fileName, File  body) throws IOException {
        // verify the required parameter 'creditNoteID' is set
        if (creditNoteID == null) {
  ...
  /**
    ...
    **/
    public Employees  updateEmployee(UUID employeeID, Employees employees) throws IOException {
        HttpResponse response = updateEmployeeForHttpResponse(employeeID, employees);
        TypeReference typeRef = new TypeReference<Employees>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse updateEmployeeForHttpResponse( UUID employeeID,  Employees employees) throws IOException {
        // verify the required parameter 'employeeID' is set
        if (employeeID == null) {
  ...
  /**
    ...
    **/
    public ExpenseClaims  updateExpenseClaim(UUID expenseClaimID, ExpenseClaims expenseClaims) throws IOException {
        HttpResponse response = updateExpenseClaimForHttpResponse(expenseClaimID, expenseClaims);
        TypeReference typeRef = new TypeReference<ExpenseClaims>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse updateExpenseClaimForHttpResponse( UUID expenseClaimID,  ExpenseClaims expenseClaims) throws IOException {
        // verify the required parameter 'expenseClaimID' is set
        if (expenseClaimID == null) {
  ...
  /**
    ...
    **/
    public Invoices  updateInvoice(UUID invoiceID, Invoices invoices) throws IOException {
        HttpResponse response = updateInvoiceForHttpResponse(invoiceID, invoices);
        TypeReference typeRef = new TypeReference<Invoices>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse updateInvoiceForHttpResponse( UUID invoiceID,  Invoices invoices) throws IOException {
        // verify the required parameter 'invoiceID' is set
        if (invoiceID == null) {
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public Attachments  updateInvoiceAttachmentByFileName(UUID invoiceID, String fileName, File body) throws IOException {
        HttpResponse response = updateInvoiceAttachmentByFileNameForHttpResponse(invoiceID, fileName, body);
        TypeReference typeRef = new TypeReference<Attachments>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse updateInvoiceAttachmentByFileNameForHttpResponse( UUID invoiceID,  String fileName, File  body) throws IOException {
        // verify the required parameter 'invoiceID' is set
        if (invoiceID == null) {
  ...
  /**
    ...
    **/
    public Items  updateItem(UUID itemID, Items items) throws IOException {
        HttpResponse response = updateItemForHttpResponse(itemID, items);
        TypeReference typeRef = new TypeReference<Items>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse updateItemForHttpResponse( UUID itemID,  Items items) throws IOException {
        // verify the required parameter 'itemID' is set
        if (itemID == null) {
  ...
  /**
    ...
    **/
    public LinkedTransactions  updateLinkedTransaction(UUID linkedTransactionID, LinkedTransactions linkedTransactions) throws IOException {
        HttpResponse response = updateLinkedTransactionForHttpResponse(linkedTransactionID, linkedTransactions);
        TypeReference typeRef = new TypeReference<LinkedTransactions>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse updateLinkedTransactionForHttpResponse( UUID linkedTransactionID,  LinkedTransactions linkedTransactions) throws IOException {
        // verify the required parameter 'linkedTransactionID' is set
        if (linkedTransactionID == null) {
  ...
  /**
    ...
    **/
    public ManualJournals  updateManualJournal(UUID manualJournalID, ManualJournals manualJournals) throws IOException {
        HttpResponse response = updateManualJournalForHttpResponse(manualJournalID, manualJournals);
        TypeReference typeRef = new TypeReference<ManualJournals>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse updateManualJournalForHttpResponse( UUID manualJournalID,  ManualJournals manualJournals) throws IOException {
        // verify the required parameter 'manualJournalID' is set
        if (manualJournalID == null) {
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public Attachments  updateManualJournalAttachmentByFileName(UUID manualJournalID, String fileName, File body) throws IOException {
        HttpResponse response = updateManualJournalAttachmentByFileNameForHttpResponse(manualJournalID, fileName, body);
        TypeReference typeRef = new TypeReference<Attachments>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse updateManualJournalAttachmentByFileNameForHttpResponse( UUID manualJournalID,  String fileName, File  body) throws IOException {
        // verify the required parameter 'manualJournalID' is set
        if (manualJournalID == null) {
  ...
  /**
    ...
    **/
    public PurchaseOrders  updatePurchaseOrder(UUID purchaseOrderID, PurchaseOrders purchaseOrders) throws IOException {
        HttpResponse response = updatePurchaseOrderForHttpResponse(purchaseOrderID, purchaseOrders);
        TypeReference typeRef = new TypeReference<PurchaseOrders>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse updatePurchaseOrderForHttpResponse( UUID purchaseOrderID,  PurchaseOrders purchaseOrders) throws IOException {
        // verify the required parameter 'purchaseOrderID' is set
        if (purchaseOrderID == null) {
  ...
  /**
    ...
    **/
    public Receipts  updateReceipt(UUID receiptID, Receipts receipts) throws IOException {
        HttpResponse response = updateReceiptForHttpResponse(receiptID, receipts);
        TypeReference typeRef = new TypeReference<Receipts>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse updateReceiptForHttpResponse( UUID receiptID,  Receipts receipts) throws IOException {
        // verify the required parameter 'receiptID' is set
        if (receiptID == null) {
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public Attachments  updateReceiptAttachmentByFileName(UUID receiptID, String fileName, File body) throws IOException {
        HttpResponse response = updateReceiptAttachmentByFileNameForHttpResponse(receiptID, fileName, body);
        TypeReference typeRef = new TypeReference<Attachments>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse updateReceiptAttachmentByFileNameForHttpResponse( UUID receiptID,  String fileName, File  body) throws IOException {
        // verify the required parameter 'receiptID' is set
        if (receiptID == null) {
  ...
  /**
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public Attachments  updateRepeatingInvoiceAttachmentByFileName(UUID repeatingInvoiceID, String fileName, File body) throws IOException {
        HttpResponse response = updateRepeatingInvoiceAttachmentByFileNameForHttpResponse(repeatingInvoiceID, fileName, body);
        TypeReference typeRef = new TypeReference<Attachments>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse updateRepeatingInvoiceAttachmentByFileNameForHttpResponse( UUID repeatingInvoiceID,  String fileName, File  body) throws IOException {
        // verify the required parameter 'repeatingInvoiceID' is set
        if (repeatingInvoiceID == null) {
  ...
  /**
    ...
    **/
    public TaxRates  updateTaxRate(TaxRates taxRates) throws IOException {
        HttpResponse response = updateTaxRateForHttpResponse(taxRates);
        TypeReference typeRef = new TypeReference<TaxRates>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse updateTaxRateForHttpResponse( TaxRates taxRates) throws IOException {
        // verify the required parameter 'taxRates' is set
        if (taxRates == null) {
  ...
  /**
    ...
    **/
    public TrackingCategories  updateTrackingCategory(UUID trackingCategoryID, TrackingCategory trackingCategory) throws IOException {
        HttpResponse response = updateTrackingCategoryForHttpResponse(trackingCategoryID, trackingCategory);
        TypeReference typeRef = new TypeReference<TrackingCategories>() {};
        return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
    }

    public HttpResponse updateTrackingCategoryForHttpResponse( UUID trackingCategoryID,  TrackingCategory trackingCategory) throws IOException {
        // verify the required parameter 'trackingCategoryID' is set
        if (trackingCategoryID == null) {
