...
public class AssetApi {
    ...
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public Asset  createAsset(String accessToken, String xeroTenantId, Asset asset, String idempotencyKey) throws IOException {
        try {
            TypeReference<Asset> typeRef = new TypeReference<Asset>() {};
            HttpResponse response = createAssetForHttpResponse(accessToken, xeroTenantId, asset, idempotencyKey);
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public HttpResponse createAssetForHttpResponse(String accessToken, String xeroTenantId, Asset asset, String idempotencyKey) throws IOException {
    ...
    * @return  AssetType
    * @throws IOException if an error occurs while attempting to invoke the API    **/
    public AssetType  createAssetType(String accessToken, String xeroTenantId, AssetType assetType, String idempotencyKey) throws IOException {
        try {
            TypeReference<AssetType> typeRef = new TypeReference<AssetType>() {};
            HttpResponse response = createAssetTypeForHttpResponse(accessToken, xeroTenantId, assetType, idempotencyKey);
            return apiClient.getObjectMapper().readValue(response.getContent(), typeRef);
        } catch (HttpResponseException e) {
            if (logger.isDebugEnabled()) {
    ...
    * @throws IOException if an error occurs while attempting to invoke the API
    **/
    public HttpResponse createAssetTypeForHttpResponse(String accessToken, String xeroTenantId, AssetType assetType, String idempotencyKey) throws IOException {
        // verify the required parameter 'xeroTenantId' is set
        if (xeroTenantId == null) {
        ...
        if (assetType == null) {
            throw new IllegalArgumentException("Missing the required parameter 'assetType' when calling createAssetType");
        }
        if (accessToken == null) {
