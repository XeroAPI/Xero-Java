...
import com.xero.api.auth.Authentication;
import com.xero.api.auth.HttpBasicAuth;
import com.xero.api.auth.HttpBearerAuth;
import com.xero.api.auth.ApiKeyAuth;
import com.xero.api.auth.OAuth;


public class ApiClient {
  protected Map<String, String> defaultHeaderMap = new HashMap<String, String>();
  protected String basePath = "https://api.xero.com/api.xro/2.0";
