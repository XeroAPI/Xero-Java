...
public class Asset {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(assetId, assetName, assetTypeId, assetNumber, purchaseDate, purchasePrice, disposalDate, disposalPrice, assetStatus, warrantyExpiryDate, serialNumber, bookDepreciationSetting, bookDepreciationDetail, canRollback, accountingBookValue, isDeleteEnabledForDate);
  }
