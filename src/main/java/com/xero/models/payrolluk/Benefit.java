...
public class Benefit {
  ...
  **/
  ...
  public Benefit standardAmount(Float standardAmount) {
  ...
  **/
  ...
  public Benefit percentage(Float percentage) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, name, category, liabilityAccountId, expenseAccountId, standardAmount, percentage, calculationType, currentRecord, subjectToNIC, subjectToPension, subjectToTax, isCalculatingOnQualifyingEarnings);
  }
