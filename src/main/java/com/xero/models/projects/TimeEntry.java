...
public class TimeEntry {
  ...
  **/
  ...
  public TimeEntry duration(Integer duration) {
   ...
   /**
   * The duration of logged minutes.descriptionA description of the time entry.
   * @return duration
  **/
  @ApiModelProperty(value = "The duration of logged minutes.descriptionA description of the time entry.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(timeEntryId, userId, projectId, taskId, dateUtc, dateEnteredUtc, duration, status);
  }
