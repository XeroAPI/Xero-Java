...
public class LeaveApplication {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(leaveApplicationID, employeeID, leaveTypeID, title, startDate, endDate, description, payOutType, leavePeriods, updatedDateUTC, validationErrors);
  }
