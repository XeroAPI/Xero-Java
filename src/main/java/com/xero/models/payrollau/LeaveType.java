...
public class LeaveType {
  ...
  **/
   ...
   * @return sgCExempt
  **/
  @ApiModelProperty(example = "true", value = "Set this to indicate that the leave type is exempt from superannuation guarantee contribution")
  /** 
   * Set this to indicate that the leave type is exempt from superannuation guarantee contribution
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(name, typeOfUnits, leaveTypeID, normalEntitlement, leaveLoadingRate, updatedDateUTC, isPaidLeave, showOnPayslip, currentRecord, leaveCategoryCode, sgCExempt);
  }
