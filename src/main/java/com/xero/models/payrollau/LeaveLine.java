...
public class LeaveLine {
  ...
  **/
  @ApiModelProperty(example = "2.5", value = "Normal ordinary earnings number of units for leave line.")
  /** 
   * Normal ordinary earnings number of units for leave line.
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(leaveTypeID, calculationType, entitlementFinalPayPayoutType, employmentTerminationPaymentType, includeSuperannuationGuaranteeContribution, numberOfUnits, annualNumberOfUnits, fullTimeNumberOfUnitsPerPeriod);
  }
