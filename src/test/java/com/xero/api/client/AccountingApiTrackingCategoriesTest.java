...
public class AccountingApiTrackingCategoriesTest {
    ...
    public void createTrackingCategoryTest() throws IOException {
        ...
        TrackingCategories response = accountingApi.createTrackingCategory(trackingCategory);
    ...
    public void createTrackingOptionsTest() throws IOException {
        ...
        TrackingOptions response = accountingApi.createTrackingOptions(trackingCategoryID, trackingOption);
    ...
    public void deleteTrackingCategoryTest() throws IOException {
        ...
        UUID trackingCategoryID = UUID.fromString("8138a266-fb42-49b2-a104-014b7045753d");  
        TrackingCategories response = accountingApi.deleteTrackingCategory(trackingCategoryID);
    ...
    public void deleteTrackingOptionsTest() throws IOException {
        ...
        TrackingOptions response = accountingApi.deleteTrackingOptions(trackingCategoryID, trackingOptionID);
    ...
    public void getTrackingCategoriesTest() throws IOException {
        ...
        TrackingCategories response = accountingApi.getTrackingCategories(where, order, includeArchived);
    ...
    public void getTrackingCategoryTest() throws IOException {
        ...
        UUID trackingCategoryID = UUID.fromString("8138a266-fb42-49b2-a104-014b7045753d");  
        TrackingCategories response = accountingApi.getTrackingCategory(trackingCategoryID);
    ...
    public void updateTrackingCategoryTest() throws IOException {
        ...
        UUID trackingCategoryID = UUID.fromString("8138a266-fb42-49b2-a104-014b7045753d");  
        TrackingCategory trackingCategory = new TrackingCategory();
        TrackingCategories response = accountingApi.updateTrackingCategory(trackingCategoryID, trackingCategory);
