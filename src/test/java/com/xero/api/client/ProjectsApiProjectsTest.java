...
public class ProjectsApiProjectsTest {
    ...
    public void getProjectsTest() throws IOException {
        ...
        int page = 1;
        int pageSize = 50;
        Projects response = projectsApi.getProjects(accessToken, xeroTenantId, projectIds, contactID, states, page, pageSize);
        ...
        assertThat(response.getItems().get(0).getCurrencyCode(), is(equalTo(com.xero.models.projects.CurrencyCode.AUD)));
        assertThat(response.getItems().get(0).getMinutesLogged(), is(equalTo(180)));
        assertThat(response.getItems().get(0).getTotalTaskAmount().getCurrency(), is(equalTo(com.xero.models.projects.CurrencyCode.AUD)));
        assertThat(response.getItems().get(0).getTotalTaskAmount().getValue(), is(equalTo(60.0)));
        assertThat(response.getItems().get(0).getTotalExpenseAmount().getCurrency(), is(equalTo(com.xero.models.projects.CurrencyCode.AUD)));
        ...
        assertThat(response.getItems().get(0).getTaskAmountInvoiced().getCurrency(), is(equalTo(com.xero.models.projects.CurrencyCode.AUD)));
        assertThat(response.getItems().get(0).getTaskAmountInvoiced().getValue(), is(equalTo(0.0)));
        assertThat(response.getItems().get(0).getExpenseAmountToBeInvoiced().getCurrency(), is(equalTo(com.xero.models.projects.CurrencyCode.AUD)));
        assertThat(response.getItems().get(0).getExpenseAmountToBeInvoiced().getValue(), is(equalTo(499.0)));
        assertThat(response.getItems().get(0).getExpenseAmountInvoiced().getCurrency(), is(equalTo(com.xero.models.projects.CurrencyCode.AUD)));
        assertThat(response.getItems().get(0).getExpenseAmountInvoiced().getValue(), is(equalTo(0.0)));
        assertThat(response.getItems().get(0).getProjectAmountInvoiced().getCurrency(), is(equalTo(com.xero.models.projects.CurrencyCode.AUD)));
        assertThat(response.getItems().get(0).getProjectAmountInvoiced().getValue(), is(equalTo(0.0)));
        assertThat(response.getItems().get(0).getDeposit().getCurrency(), is(equalTo(com.xero.models.projects.CurrencyCode.AUD)));
        assertThat(response.getItems().get(0).getDeposit().getValue(), is(equalTo(0.0)));
        assertThat(response.getItems().get(0).getDepositApplied().getCurrency(), is(equalTo(com.xero.models.projects.CurrencyCode.AUD)));
        assertThat(response.getItems().get(0).getDepositApplied().getValue(), is(equalTo(0.0)));
        assertThat(response.getItems().get(0).getCreditNoteAmount().getCurrency(), is(equalTo(com.xero.models.projects.CurrencyCode.AUD)));
        assertThat(response.getItems().get(0).getCreditNoteAmount().getValue(), is(equalTo(0.0)));
        assertThat(response.getItems().get(0).getTotalInvoiced().getCurrency(), is(equalTo(com.xero.models.projects.CurrencyCode.AUD)));
        assertThat(response.getItems().get(0).getTotalInvoiced().getValue(), is(equalTo(0.0)));
        assertThat(response.getItems().get(0).getTotalToBeInvoiced().getCurrency(), is(equalTo(com.xero.models.projects.CurrencyCode.AUD)));
        assertThat(response.getItems().get(0).getTotalToBeInvoiced().getValue(), is(equalTo(559.0)));
        assertThat(response.getItems().get(0).getEstimate().getCurrency(), is(equalTo(com.xero.models.projects.CurrencyCode.AUD)));
    ...
    public void createProjectsTest() throws IOException {
        ...
        Project response = projectsApi.createProject(accessToken, xeroTenantId, projectCreateOrUpdate);
        ...
        assertThat(response.getCurrencyCode(), is(equalTo(com.xero.models.projects.CurrencyCode.AUD)));
        assertThat(response.getMinutesLogged(), is(equalTo(0)));
        assertThat(response.getTotalTaskAmount().getCurrency(), is(equalTo(com.xero.models.projects.CurrencyCode.AUD)));
        assertThat(response.getTotalTaskAmount().getValue(), is(equalTo(0.0)));
        assertThat(response.getTotalExpenseAmount().getCurrency(), is(equalTo(com.xero.models.projects.CurrencyCode.AUD)));
        assertThat(response.getTotalExpenseAmount().getValue(), is(equalTo(0.0)));
        assertThat(response.getMinutesToBeInvoiced(), is(equalTo(0)));
        assertThat(response.getTaskAmountInvoiced().getCurrency(), is(equalTo(com.xero.models.projects.CurrencyCode.AUD)));
        assertThat(response.getTaskAmountInvoiced().getValue(), is(equalTo(0.0)));
        assertThat(response.getExpenseAmountToBeInvoiced().getCurrency(), is(equalTo(com.xero.models.projects.CurrencyCode.AUD)));
        assertThat(response.getExpenseAmountToBeInvoiced().getValue(), is(equalTo(0.0)));
        assertThat(response.getExpenseAmountInvoiced().getCurrency(), is(equalTo(com.xero.models.projects.CurrencyCode.AUD)));
        assertThat(response.getExpenseAmountInvoiced().getValue(), is(equalTo(0.0)));
        assertThat(response.getProjectAmountInvoiced().getCurrency(), is(equalTo(com.xero.models.projects.CurrencyCode.AUD)));
        assertThat(response.getProjectAmountInvoiced().getValue(), is(equalTo(0.0)));
        assertThat(response.getDeposit().getCurrency(), is(equalTo(com.xero.models.projects.CurrencyCode.AUD)));
        assertThat(response.getDeposit().getValue(), is(equalTo(0.0)));
        assertThat(response.getDepositApplied().getCurrency(), is(equalTo(com.xero.models.projects.CurrencyCode.AUD)));
        assertThat(response.getDepositApplied().getValue(), is(equalTo(0.0)));
        assertThat(response.getCreditNoteAmount().getCurrency(), is(equalTo(com.xero.models.projects.CurrencyCode.AUD)));
        assertThat(response.getCreditNoteAmount().getValue(), is(equalTo(0.0)));
        assertThat(response.getTotalInvoiced().getCurrency(), is(equalTo(com.xero.models.projects.CurrencyCode.AUD)));
        assertThat(response.getTotalInvoiced().getValue(), is(equalTo(0.0)));
        assertThat(response.getTotalToBeInvoiced().getCurrency(), is(equalTo(com.xero.models.projects.CurrencyCode.AUD)));
        assertThat(response.getTotalToBeInvoiced().getValue(), is(equalTo(0.0)));
        assertThat(response.getEstimate().getCurrency(), is(equalTo(com.xero.models.projects.CurrencyCode.AUD)));
        ...
        assertThat(response.getStatus(), is(equalTo(com.xero.models.projects.ProjectStatus.INPROGRESS)));
    ...
    public void getProjectTest() throws IOException {
        ...
        Project response = projectsApi.getProject(accessToken, xeroTenantId, projectId);
