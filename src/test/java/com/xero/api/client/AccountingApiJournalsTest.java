...
public class AccountingApiJournalsTest {
    ...
    public void getJournalTest() throws IOException {
        ...
        assertThat(response.getJournals().get(0).getJournalDate(), is(equalTo(LocalDate.of(2018,10,20))));
        assertThat(response.getJournals().get(0).getJournalNumber(), is(equalTo("1")));
        assertThat(response.getJournals().get(0).getCreatedDateUTC(), is(equalTo(OffsetDateTime.parse("2018-11-02T17:30:43.467+01:00"))));
