...
public class AccountingApiQuotesTest {
	...
	public void setUp() {
        ...
        try (InputStream input = AccountingApiQuotesTest.class.getClassLoader().getResourceAsStream("config.properties")){
	...
	public void testUpdateQuote() throws Exception {
        ...
        Quotes quotes = accountingApi.updateQuote(accessToken, xeroTenantId, quoteID, upQuote, null);
