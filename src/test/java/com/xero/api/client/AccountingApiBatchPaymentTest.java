...
public class AccountingApiBatchPaymentTest {
  ...
  public void testGetBatchPayment() throws Exception {
    ...
    BatchPayments batchPayments =
        accountingApi.getBatchPayments(accessToken, xeroTenantId, ifModifiedSince, where, order);
    assertThat(
        batchPayments.getBatchPayments().get(0).getBatchPaymentID().toString(),
        is(equalTo("d0e9bbbf-5b8a-48b6-906a-035591fcb061")));
  ...
  public void testCreateBatchPayment() throws Exception {
    ...
    BatchPayments newBatchPayments =
        accountingApi.createBatchPayment(accessToken, xeroTenantId, createBatchPayments, false);
    assertThat(
        newBatchPayments.getBatchPayments().get(0).getBatchPaymentID().toString(),
        is(equalTo("d318c343-208e-49fe-b04a-45642349bcf1")));
  ...
  public void testGetBatchPaymentsHistory() throws Exception {
    ...
    HistoryRecords hr =
        accountingApi.getBatchPaymentHistory(accessToken, xeroTenantId, batchPaymentID);
  ...
  public void testcreateBatchPaymentHistoryRecord() throws Exception {
    ...
    HistoryRecords newHistory =
        accountingApi.createBatchPaymentHistoryRecord(
            accessToken, xeroTenantId, batchPaymentID, newHistoryRecords);
