...
public class AccountingApiAccountsTest {
	...
	public void testGetAccount() throws Exception {
		...
		Accounts oneAccount = accountingApi.getAccount(xeroTenantId,accountID);
	...
	public void testUpdateAccount() throws Exception {
		...
		Accounts updatedAccount = accountingApi.updateAccount(xeroTenantId,accountID, accts);
	...
	public void testDeleteAccount() throws Exception {		
		...
		UUID accountID = UUID.fromString("297c2dc5-cc47-4afd-8ec8-74990b8761e9");
		Accounts deleteAccount = accountingApi.deleteAccount(xeroTenantId,accountID);
	...
	public void testCreateAccountAttachmentByFileName() throws Exception {		
		...
		Attachments createAccountsAttachments = accountingApi.createAccountAttachmentByFileName(xeroTenantId,accountID, newFileName, bytes);					
...
/*
	...
	public void testUpdateAccountAttachmentByFileName() throws Exception {		
		...
		Attachments createAccountsAttachments = accountingApi.updateAccountAttachmentByFileName(xeroTenantId, accountID, newFileName, bytes);					
