...
public class ProjectsApiProjectTasksTest {
    ...
    public void getTasksTest() throws IOException {
        ...
        int page = 1;
        int pageSize = 50;
        Tasks response = projectsApi.getTasks(accessToken, xeroTenantId, projectId, page, pageSize, taskIds);
        ...
        assertThat(response.getItems().get(0).getRate().getCurrency(), is(equalTo(com.xero.models.projects.CurrencyCode.AUD)));
        assertThat(response.getItems().get(0).getRate().getValue(), is(equalTo(20.0)));
        assertThat(response.getItems().get(0).getChargeType(), is(equalTo(com.xero.models.projects.ChargeType.TIME)));
        ...
        assertThat(response.getItems().get(0).getTotalAmount().getCurrency(), is(equalTo(com.xero.models.projects.CurrencyCode.AUD)));
        ...
        assertThat(response.getItems().get(0).getAmountInvoiced().getCurrency(), is(equalTo(com.xero.models.projects.CurrencyCode.AUD)));
        assertThat(response.getItems().get(0).getAmountInvoiced().getValue(), is(equalTo(0.0)));        
        assertThat(response.getItems().get(0).getAmountToBeInvoiced().getCurrency(), is(equalTo(com.xero.models.projects.CurrencyCode.AUD)));
        assertThat(response.getItems().get(0).getAmountToBeInvoiced().getValue(), is(equalTo(60.0)));
        assertThat(response.getItems().get(0).getStatus(), is(equalTo(com.xero.models.projects.Task.StatusEnum.ACTIVE)));
    ...
    public void getTaskTest() throws IOException {
        ...
        Task response = projectsApi.getTask(accessToken, xeroTenantId, projectId, taskId);
        ...
        assertThat(response.getRate().getCurrency(), is(equalTo(com.xero.models.projects.CurrencyCode.AUD)));
        assertThat(response.getRate().getValue(), is(equalTo(20.0)));
        assertThat(response.getChargeType(), is(equalTo(com.xero.models.projects.ChargeType.TIME)));
        ...
        assertThat(response.getTotalAmount().getCurrency(), is(equalTo(com.xero.models.projects.CurrencyCode.AUD)));
        ...
        assertThat(response.getAmountInvoiced().getCurrency(), is(equalTo(com.xero.models.projects.CurrencyCode.AUD)));
        assertThat(response.getAmountInvoiced().getValue(), is(equalTo(0.0)));        
        assertThat(response.getAmountToBeInvoiced().getCurrency(), is(equalTo(com.xero.models.projects.CurrencyCode.AUD)));
        assertThat(response.getAmountToBeInvoiced().getValue(), is(equalTo(100.0)));
        assertThat(response.getStatus(), is(equalTo(com.xero.models.projects.Task.StatusEnum.ACTIVE)));
