...
public class PayrollUkApiEmployeeStatutorySickLeaveTest {
    ...
    public void createEmployeeStatutorySickLeaveTest() throws IOException {
        ...
        employeeStatutorySickLeave.setEmployeeID(UUID.randomUUID());
        employeeStatutorySickLeave.setEndDate(LocalDate.of(2020, 04, 21));
        employeeStatutorySickLeave.setStartDate(LocalDate.of(2020, 04, 21));
        employeeStatutorySickLeave.setWorkPattern(List.of("Monday", "Wednesday"));
        employeeStatutorySickLeave.setLeaveTypeID(UUID.randomUUID());
        employeeStatutorySickLeave.isPregnancyRelated(false);
