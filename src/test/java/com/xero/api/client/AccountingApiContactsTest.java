...
public class AccountingApiContactsTest {
    ...
    public void createContactAttachmentByFileNameTest() throws IOException {
        ...
        /*
        assertThat(response.getAttachments().get(0).getAttachmentID(), is(equalTo(UUID.fromString("3fa85f64-5717-4562-b3fc-2c963f66afa6"))));
        ...
        assertThat(response.getAttachments().get(0).getUrl(), is(equalTo("https://api.xero.com/api.xro/2.0/Accounts/da962997-a8bd-4dff-9616-01cdc199283f/Attachments/sample5.jpg")));
        assertThat(response.getAttachments().get(0).getContentLength(), is(equalTo(new BigDecimal("1.5"))));
        assertThat(response.getAttachments().get(0).getIncludeOnline(), is(equalTo(true)));
        */
    ...
    @Test
     public void getContactAttachmentsTest() throws IOException {
        ...
        UUID contactID = UUID.fromString("297c2dc5-cc47-4afd-8ec8-74990b8761e9");  
        Attachments response2 = api.getContactAttachments(contactID);
/*
        assertThat(response.getAttachments().get(0).getAttachmentID(), is(equalTo(UUID.fromString("3fa85f64-5717-4562-b3fc-2c963f66afa6"))));
        assertThat(response.getAttachments().get(0).getFileName(), is(equalTo("sample5.jpg")));
        assertThat(response.getAttachments().get(0).getMimeType(), is(equalTo("image/jpg")));
        ...
        assertThat(response.getAttachments().get(0).getIncludeOnline(), is(equalTo(true)));
    */
        System.out.println(response2.getAttachments().get(0).toString());
    }
